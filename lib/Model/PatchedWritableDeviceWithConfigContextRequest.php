...
/**
 * PatchedWritableDeviceWithConfigContextRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableDeviceWithConfigContextRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableDeviceWithConfigContextRequest';
    ...
    protected static $openAPITypes = [
        ...
        'oob_ip' => '\OpenAPI\Client\Model\BriefIPAddressRequest',
        'cluster' => '\OpenAPI\Client\Model\BriefClusterRequest',
        'virtual_chassis' => '\OpenAPI\Client\Model\BriefVirtualChassisRequest',
        'vc_position' => 'int',
        'vc_priority' => 'int',
        'description' => 'string',
        'comments' => 'string',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setSerial($serial)
    {
        ...
        if ((mb_strlen($serial) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setAssetTag($asset_tag)
    {
        ...
        if (!is_null($asset_tag) && (mb_strlen($asset_tag) > 50)) {
            throw new \InvalidArgumentException('invalid length for $asset_tag when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setPosition($position)
    {
        ...
        if (!is_null($position) && ($position >= 1000)) {
            throw new \InvalidArgumentException('invalid value for $position when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than 1000.');
        }
        if (!is_null($position) && ($position < 0.5)) {
            throw new \InvalidArgumentException('invalid value for $position when calling PatchedWritableDeviceWithConfigContextRequest., must be bigger than or equal to 0.5.');
        }
     ...
     * Sets face
     *
     * @param string|null $face * `front` - Front * `rear` - Rear
     *
     * @return self
     */
    ...
    public function setLatitude($latitude)
    {
        ...
        if (!is_null($latitude) && ($latitude >= 100)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than 100.');
        }
        if (!is_null($latitude) && ($latitude <= -100)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling PatchedWritableDeviceWithConfigContextRequest., must be bigger than -100.');
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if (!is_null($longitude) && ($longitude >= 1000)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than 1000.');
        }
        if (!is_null($longitude) && ($longitude <= -1000)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling PatchedWritableDeviceWithConfigContextRequest., must be bigger than -1000.');
        }
     ...
     * Sets oob_ip
     *
     * @param \OpenAPI\Client\Model\BriefIPAddressRequest|null $oob_ip oob_ip
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\BriefVirtualChassisRequest|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BriefVirtualChassisRequest|null $virtual_chassis virtual_chassis
     *
     * @return self
     */
    ...
    public function setVcPosition($vc_position)
    {
        ...
        if (!is_null($vc_position) && ($vc_position > 255)) {
            throw new \InvalidArgumentException('invalid value for $vc_position when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($vc_position) && ($vc_position < 0)) {
            throw new \InvalidArgumentException('invalid value for $vc_position when calling PatchedWritableDeviceWithConfigContextRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setVcPriority($vc_priority)
    {
        ...
        if (!is_null($vc_priority) && ($vc_priority > 255)) {
            throw new \InvalidArgumentException('invalid value for $vc_priority when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($vc_priority) && ($vc_priority < 0)) {
            throw new \InvalidArgumentException('invalid value for $vc_priority when calling PatchedWritableDeviceWithConfigContextRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableDeviceWithConfigContextRequest., must be smaller than or equal to 200.');
        }
