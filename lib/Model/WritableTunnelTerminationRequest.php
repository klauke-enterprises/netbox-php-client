...
/**
 * WritableTunnelTerminationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableTunnelTerminationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableTunnelTerminationRequest';
    ...
    */
     ...
     * Gets tunnel
     *
     * @return \OpenAPI\Client\Model\BriefTunnelRequest
     */
     ...
     * Sets tunnel
     *
     * @param \OpenAPI\Client\Model\BriefTunnelRequest $tunnel tunnel
     *
     * @return self
     */
    ...
    public function setTerminationId($termination_id)
    {
        ...
        if (!is_null($termination_id) && ($termination_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $termination_id when calling WritableTunnelTerminationRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($termination_id) && ($termination_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $termination_id when calling WritableTunnelTerminationRequest., must be bigger than or equal to 0.');
        }
