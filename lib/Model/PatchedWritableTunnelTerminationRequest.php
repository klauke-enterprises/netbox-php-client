...
/**
 * PatchedWritableTunnelTerminationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableTunnelTerminationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableTunnelTerminationRequest';
    ...
    protected static $openAPITypes = [
        'tunnel' => '\OpenAPI\Client\Model\BriefTunnelRequest',
        'role' => 'string',
        'termination_type' => 'string',
        'termination_id' => 'int',
        'outside_ip' => '\OpenAPI\Client\Model\BriefIPAddressRequest',
    ...
    */
     ...
     * Gets tunnel
     *
     * @return \OpenAPI\Client\Model\BriefTunnelRequest|null
     */
     ...
     * Sets tunnel
     *
     * @param \OpenAPI\Client\Model\BriefTunnelRequest|null $tunnel tunnel
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role * `peer` - Peer * `hub` - Hub * `spoke` - Spoke
     *
     * @return self
     */
    ...
    public function setTerminationId($termination_id)
    {
        ...
        if (!is_null($termination_id) && ($termination_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $termination_id when calling PatchedWritableTunnelTerminationRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($termination_id) && ($termination_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $termination_id when calling PatchedWritableTunnelTerminationRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets outside_ip
     *
     * @param \OpenAPI\Client\Model\BriefIPAddressRequest|null $outside_ip outside_ip
     *
     * @return self
     */
