...
/**
 * NestedDeviceRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedDeviceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedDeviceRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NestedDeviceRequest., must be smaller than or equal to 64.');
        }
