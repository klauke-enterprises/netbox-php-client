...
/**
 * PaginatedObjectChangeList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedObjectChangeList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedObjectChangeList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\ObjectChange[]'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\ObjectChange[] $results results
     *
     * @return self
     */
