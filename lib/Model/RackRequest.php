 ...
 */
class RackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RackRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RackRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RackRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFacilityId($facility_id)
    {
        ...
        if (!is_null($facility_id) && (mb_strlen($facility_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $facility_id when calling RackRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setSerial($serial)
    {
        ...
        if ((mb_strlen($serial) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial when calling RackRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setAssetTag($asset_tag)
    {
        ...
        if (!is_null($asset_tag) && (mb_strlen($asset_tag) > 50)) {
            throw new \InvalidArgumentException('invalid length for $asset_tag when calling RackRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setUHeight($u_height)
    {
        ...
        if (($u_height > 100)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling RackRequest., must be smaller than or equal to 100.');
        }
        if (($u_height < 1)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling RackRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setStartingUnit($starting_unit)
    {
        ...
        if (($starting_unit > 32767)) {
            throw new \InvalidArgumentException('invalid value for $starting_unit when calling RackRequest., must be smaller than or equal to 32767.');
        }
        if (($starting_unit < 1)) {
            throw new \InvalidArgumentException('invalid value for $starting_unit when calling RackRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling RackRequest., must be smaller than 1000000.');
        }
        if (!is_null($weight) && ($weight <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling RackRequest., must be bigger than -1000000.');
        }
    ...
    public function setMaxWeight($max_weight)
    {
        ...
        if (!is_null($max_weight) && ($max_weight > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $max_weight when calling RackRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($max_weight) && ($max_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_weight when calling RackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setOuterWidth($outer_width)
    {
        ...
        if (!is_null($outer_width) && ($outer_width > 32767)) {
            throw new \InvalidArgumentException('invalid value for $outer_width when calling RackRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($outer_width) && ($outer_width < 0)) {
            throw new \InvalidArgumentException('invalid value for $outer_width when calling RackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setOuterDepth($outer_depth)
    {
        ...
        if (!is_null($outer_depth) && ($outer_depth > 32767)) {
            throw new \InvalidArgumentException('invalid value for $outer_depth when calling RackRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($outer_depth) && ($outer_depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $outer_depth when calling RackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMountingDepth($mounting_depth)
    {
        ...
        if (!is_null($mounting_depth) && ($mounting_depth > 32767)) {
            throw new \InvalidArgumentException('invalid value for $mounting_depth when calling RackRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($mounting_depth) && ($mounting_depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $mounting_depth when calling RackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RackRequest., must be smaller than or equal to 200.');
        }
