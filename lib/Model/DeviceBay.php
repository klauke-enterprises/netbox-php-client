 ...
 */
class DeviceBay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceBay';
    ...
    protected static $openAPITypes = [
        ...
        'label' => 'string',
        'description' => 'string',
        'installed_device' => '\OpenAPI\Client\Model\BriefDevice',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DeviceBay., must be smaller than or equal to 64.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling DeviceBay., must be smaller than or equal to 64.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DeviceBay., must be smaller than or equal to 200.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\BriefDevice|null $installed_device installed_device
     *
     * @return self
     */
