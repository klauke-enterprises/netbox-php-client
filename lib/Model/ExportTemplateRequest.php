...
/**
 * ExportTemplateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ExportTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportTemplateRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ExportTemplateRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ExportTemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ExportTemplateRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setTemplateCode($template_code)
    {
        ...
        if ((mb_strlen($template_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $template_code when calling ExportTemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMimeType($mime_type)
    {
        ...
        if ((mb_strlen($mime_type) > 50)) {
            throw new \InvalidArgumentException('invalid length for $mime_type when calling ExportTemplateRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setFileExtension($file_extension)
    {
        ...
        if ((mb_strlen($file_extension) > 15)) {
            throw new \InvalidArgumentException('invalid length for $file_extension when calling ExportTemplateRequest., must be smaller than or equal to 15.');
        }
