...
/**
 * ModuleBayNestedModuleRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ModuleBayNestedModuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModuleBayNestedModuleRequest';
    ...
    */
    ...
    public function setSerial($serial)
    {
        ...
        if ((mb_strlen($serial) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial when calling ModuleBayNestedModuleRequest., must be smaller than or equal to 50.');
        }
