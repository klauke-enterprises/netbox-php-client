 ...
 */
class FHRPGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FHRPGroup';
    ...
    protected static $openAPITypes = [
        ...
        'ip_addresses' => '\OpenAPI\Client\Model\BriefIPAddress[]'
    ];
    ...
    public const AUTH_TYPE_PLAINTEXT = 'plaintext';
    public const AUTH_TYPE_MD5 = 'md5';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['auth_key']) && (mb_strlen($this->container['auth_key']) > 255)) {
            $invalidProperties[] = "invalid value for 'auth_key', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FHRPGroup., must be smaller than or equal to 100.');
        }
    ...
    public function setGroupId($group_id)
    {
        ...
        if (($group_id > 32767)) {
            throw new \InvalidArgumentException('invalid value for $group_id when calling FHRPGroup., must be smaller than or equal to 32767.');
        }
        if (($group_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $group_id when calling FHRPGroup., must be bigger than or equal to 0.');
        }
     ...
     * Sets auth_type
     *
     * @param string|null $auth_type * `plaintext` - Plaintext * `md5` - MD5
     *
     * @return self
     */
    ...
    public function setAuthKey($auth_key)
    {
        ...
        if ((mb_strlen($auth_key) > 255)) {
            throw new \InvalidArgumentException('invalid length for $auth_key when calling FHRPGroup., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling FHRPGroup., must be smaller than or equal to 200.');
        }
     ...
     * Sets ip_addresses
     *
     * @param \OpenAPI\Client\Model\BriefIPAddress[] $ip_addresses ip_addresses
     *
     * @return self
     */
