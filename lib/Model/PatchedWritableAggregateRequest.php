...
/**
 * PatchedWritableAggregateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableAggregateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableAggregateRequest';
    ...
    */
    ...
    public function setPrefix($prefix)
    {
        ...
        if ((mb_strlen($prefix) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling PatchedWritableAggregateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableAggregateRequest., must be smaller than or equal to 200.');
        }
