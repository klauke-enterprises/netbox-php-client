...
/**
 * InterfaceMode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InterfaceMode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Interface_mode';
    ...
    public const VALUE_ACCESS = 'access';
    public const VALUE_TAGGED = 'tagged';
    public const VALUE_TAGGED_ALL = 'tagged-all';
    public const VALUE_EMPTY = '';
    public const LABEL_ACCESS = 'Access';
    public const LABEL_TAGGED = 'Tagged';
    public const LABEL_TAGGED__ALL = 'Tagged (All)';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `access` - Access * `tagged` - Tagged * `tagged-all` - Tagged (All)
     *
     * @return self
     */
