...
/**
 * CableLengthUnit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CableLengthUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cable_length_unit';
    ...
    public const VALUE_MI = 'mi';
    public const VALUE_FT = 'ft';
    public const VALUE_IN = 'in';
    public const VALUE_EMPTY = '';
    public const VALUE_NULL = 'null';
    public const LABEL_KILOMETERS = 'Kilometers';
    public const LABEL_METERS = 'Meters';
    public const LABEL_CENTIMETERS = 'Centimeters';
    public const LABEL_MILES = 'Miles';
    public const LABEL_FEET = 'Feet';
    public const LABEL_INCHES = 'Inches';
    ...
    {
        return [
            self::LABEL_KILOMETERS,
            self::LABEL_METERS,
            self::LABEL_CENTIMETERS,
            self::LABEL_MILES,
            self::LABEL_FEET,
            self::LABEL_INCHES,
        ];
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `km` - Kilometers * `m` - Meters * `cm` - Centimeters * `mi` - Miles * `ft` - Feet * `in` - Inches
     *
     * @return self
     */
