...
/**
 * WritableConsolePortRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableConsolePortRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableConsolePortRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableConsolePortRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableConsolePortRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling WritableConsolePortRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setSpeed($speed)
    {
        ...
        if (!is_null($speed) && ($speed > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $speed when calling WritableConsolePortRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($speed) && ($speed < 0)) {
            throw new \InvalidArgumentException('invalid value for $speed when calling WritableConsolePortRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableConsolePortRequest., must be smaller than or equal to 200.');
        }
