...
/**
 * PatchedWritableIPAddressRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableIPAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableIPAddressRequest';
    ...
    */
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling PatchedWritableIPAddressRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param string|null $status The operational status of this IP  * `active` - Active * `reserved` - Reserved * `deprecated` - Deprecated * `dhcp` - DHCP * `slaac` - SLAAC
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string|null $role The functional role of this IP  * `loopback` - Loopback * `secondary` - Secondary * `anycast` - Anycast * `vip` - VIP * `vrrp` - VRRP * `hsrp` - HSRP * `glbp` - GLBP * `carp` - CARP
     *
     * @return self
     */
    ...
    public function setAssignedObjectId($assigned_object_id)
    {
        ...
        if (!is_null($assigned_object_id) && ($assigned_object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $assigned_object_id when calling PatchedWritableIPAddressRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($assigned_object_id) && ($assigned_object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $assigned_object_id when calling PatchedWritableIPAddressRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets nat_inside
     *
     * @param int|null $nat_inside The IP for which this address is the \"outside\" IP
     *
     * @return self
     */
    ...
    public function setDnsName($dns_name)
    {
        ...
        if ((mb_strlen($dns_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $dns_name when calling PatchedWritableIPAddressRequest., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/^([0-9A-Za-z_-]+|\\*)(\\.[0-9A-Za-z_-]+)*\\.?$/", ObjectSerializer::toString($dns_name)))) {
            throw new \InvalidArgumentException("invalid value for \$dns_name when calling PatchedWritableIPAddressRequest., must conform to the pattern /^([0-9A-Za-z_-]+|\\*)(\\.[0-9A-Za-z_-]+)*\\.?$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableIPAddressRequest., must be smaller than or equal to 200.');
        }
