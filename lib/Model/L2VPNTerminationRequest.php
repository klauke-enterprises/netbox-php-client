...
/**
 * L2VPNTerminationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class L2VPNTerminationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'L2VPNTerminationRequest';
    ...
    protected static $openAPITypes = [
        'l2vpn' => '\OpenAPI\Client\Model\BriefL2VPNRequest',
    ...
    */
     ...
     * Gets l2vpn
     *
     * @return \OpenAPI\Client\Model\BriefL2VPNRequest
     */
     ...
     * Sets l2vpn
     *
     * @param \OpenAPI\Client\Model\BriefL2VPNRequest $l2vpn l2vpn
     *
     * @return self
     */
    ...
    public function setAssignedObjectId($assigned_object_id)
    {
        ...
        if (($assigned_object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $assigned_object_id when calling L2VPNTerminationRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (($assigned_object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $assigned_object_id when calling L2VPNTerminationRequest., must be bigger than or equal to 0.');
        }
