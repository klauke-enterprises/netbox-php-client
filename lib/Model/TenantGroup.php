...
class TenantGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'slug' => 'string',
        'parent' => '\OpenAPI\Client\Model\NestedTenantGroup',
        'description' => 'string',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TenantGroup., must be smaller than or equal to 100.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling TenantGroup., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling TenantGroup., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
     ...
     * Gets parent
     *
     * @return \OpenAPI\Client\Model\NestedTenantGroup|null
     */
     ...
     * Sets parent
     *
     * @param \OpenAPI\Client\Model\NestedTenantGroup|null $parent parent
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TenantGroup., must be smaller than or equal to 200.');
        }
