...
/**
 * PatchedCircuitTerminationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedCircuitTerminationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedCircuitTerminationRequest';
    ...
    protected static $openAPITypes = [
        'circuit' => '\OpenAPI\Client\Model\CircuitRequest',
        'term_side' => 'string',
        'site' => '\OpenAPI\Client\Model\SiteRequest',
        'provider_network' => '\OpenAPI\Client\Model\ProviderNetworkRequest',
        'port_speed' => 'int',
        'upstream_speed' => 'int',
        'xconnect_id' => 'string',
        'pp_info' => 'string',
    ...
    */
     ...
     * Gets circuit
     *
     * @return \OpenAPI\Client\Model\CircuitRequest|null
     */
     ...
     * Sets circuit
     *
     * @param \OpenAPI\Client\Model\CircuitRequest|null $circuit circuit
     *
     * @return self
     */
     ...
     * Sets term_side
     *
     * @param string|null $term_side * `A` - A * `Z` - Z
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ProviderNetworkRequest|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ProviderNetworkRequest|null $provider_network provider_network
     *
     * @return self
     */
    ...
    public function setPortSpeed($port_speed)
    {
        ...
        if (!is_null($port_speed) && ($port_speed > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $port_speed when calling PatchedCircuitTerminationRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($port_speed) && ($port_speed < 0)) {
            throw new \InvalidArgumentException('invalid value for $port_speed when calling PatchedCircuitTerminationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setUpstreamSpeed($upstream_speed)
    {
        ...
        if (!is_null($upstream_speed) && ($upstream_speed > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $upstream_speed when calling PatchedCircuitTerminationRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($upstream_speed) && ($upstream_speed < 0)) {
            throw new \InvalidArgumentException('invalid value for $upstream_speed when calling PatchedCircuitTerminationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setXconnectId($xconnect_id)
    {
        ...
        if ((mb_strlen($xconnect_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $xconnect_id when calling PatchedCircuitTerminationRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setPpInfo($pp_info)
    {
        ...
        if ((mb_strlen($pp_info) > 100)) {
            throw new \InvalidArgumentException('invalid length for $pp_info when calling PatchedCircuitTerminationRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedCircuitTerminationRequest., must be smaller than or equal to 200.');
        }
