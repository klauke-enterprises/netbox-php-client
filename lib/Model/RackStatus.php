...
class RackStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const LABEL_AVAILABLE = 'Available';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `reserved` - Reserved * `available` - Available * `planned` - Planned * `active` - Active * `deprecated` - Deprecated
     *
     * @return self
     */
