...
/**
 * RackReservationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class RackReservationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RackReservationRequest';
    ...
    */
     ...
     * Gets rack
     *
     * @return \OpenAPI\Client\Model\BriefRackRequest
     */
     ...
     * Sets rack
     *
     * @param \OpenAPI\Client\Model\BriefRackRequest $rack rack
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RackReservationRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RackReservationRequest., must be bigger than or equal to 1.');
        }
