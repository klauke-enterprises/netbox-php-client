...
/**
 * CableTermination Class Doc Comment
 *
 * @category Class
 ...
 */
class CableTermination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CableTermination';
    ...
    */
    ...
    public function setTerminationId($termination_id)
    {
        ...
        if (($termination_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $termination_id when calling CableTermination., must be smaller than or equal to 9223372036854775807.');
        }
        if (($termination_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $termination_id when calling CableTermination., must be bigger than or equal to 0.');
        }
