...
/**
 * PatchedWritableInterfaceRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableInterfaceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableInterfaceRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableInterfaceRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableInterfaceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PatchedWritableInterfaceRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setMtu($mtu)
    {
        ...
        if (!is_null($mtu) && ($mtu > 65536)) {
            throw new \InvalidArgumentException('invalid value for $mtu when calling PatchedWritableInterfaceRequest., must be smaller than or equal to 65536.');
        }
        if (!is_null($mtu) && ($mtu < 1)) {
            throw new \InvalidArgumentException('invalid value for $mtu when calling PatchedWritableInterfaceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSpeed($speed)
    {
        ...
        if (!is_null($speed) && ($speed > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $speed when calling PatchedWritableInterfaceRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($speed) && ($speed < 0)) {
            throw new \InvalidArgumentException('invalid value for $speed when calling PatchedWritableInterfaceRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableInterfaceRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setRfChannelFrequency($rf_channel_frequency)
    {
        ...
        if (!is_null($rf_channel_frequency) && ($rf_channel_frequency >= 100000)) {
            throw new \InvalidArgumentException('invalid value for $rf_channel_frequency when calling PatchedWritableInterfaceRequest., must be smaller than 100000.');
        }
        if (!is_null($rf_channel_frequency) && ($rf_channel_frequency <= -100000)) {
            throw new \InvalidArgumentException('invalid value for $rf_channel_frequency when calling PatchedWritableInterfaceRequest., must be bigger than -100000.');
        }
    ...
    public function setRfChannelWidth($rf_channel_width)
    {
        ...
        if (!is_null($rf_channel_width) && ($rf_channel_width >= 10000)) {
            throw new \InvalidArgumentException('invalid value for $rf_channel_width when calling PatchedWritableInterfaceRequest., must be smaller than 10000.');
        }
        if (!is_null($rf_channel_width) && ($rf_channel_width <= -10000)) {
            throw new \InvalidArgumentException('invalid value for $rf_channel_width when calling PatchedWritableInterfaceRequest., must be bigger than -10000.');
        }
    ...
    public function setTxPower($tx_power)
    {
        ...
        if (!is_null($tx_power) && ($tx_power > 127)) {
            throw new \InvalidArgumentException('invalid value for $tx_power when calling PatchedWritableInterfaceRequest., must be smaller than or equal to 127.');
        }
        if (!is_null($tx_power) && ($tx_power < 0)) {
            throw new \InvalidArgumentException('invalid value for $tx_power when calling PatchedWritableInterfaceRequest., must be bigger than or equal to 0.');
        }
