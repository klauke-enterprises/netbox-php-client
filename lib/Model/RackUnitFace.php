...
/**
 * RackUnitFace Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RackUnitFace implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RackUnit_face';
    ...
    public const VALUE_FRONT = 'front';
    public const VALUE_REAR = 'rear';
    public const LABEL_FRONT = 'Front';
    public const LABEL_REAR = 'Rear';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `front` - Front * `rear` - Rear
     *
     * @return self
     */
