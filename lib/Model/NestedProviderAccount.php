...
/**
 * NestedProviderAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedProviderAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedProviderAccount';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NestedProviderAccount., must be smaller than or equal to 100.');
        }
    ...
    public function setAccount($account)
    {
        ...
        if ((mb_strlen($account) > 100)) {
            throw new \InvalidArgumentException('invalid length for $account when calling NestedProviderAccount., must be smaller than or equal to 100.');
        }
