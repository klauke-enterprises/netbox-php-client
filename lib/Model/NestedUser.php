 ...
 */
class NestedUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedUser';
    ...
    */
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 150)) {
            throw new \InvalidArgumentException('invalid length for $username when calling NestedUser., must be smaller than or equal to 150.');
        }
        if ((!preg_match("/^[\\w.@+-]+$/", ObjectSerializer::toString($username)))) {
            throw new \InvalidArgumentException("invalid value for \$username when calling NestedUser., must conform to the pattern /^[\\w.@+-]+$/.");
        }
