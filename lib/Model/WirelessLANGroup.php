...
/**
 * WirelessLANGroup Class Doc Comment
 *
 * @category Class
 ...
 */
class WirelessLANGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WirelessLANGroup';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'slug' => 'string',
        'parent' => '\OpenAPI\Client\Model\NestedWirelessLANGroup',
        'description' => 'string',
    ...
    protected static $setters = [
        ...
        'wirelesslan_count' => 'setWirelesslanCount',
        '_depth' => 'setDepth'
    ];
    ...
    protected static $getters = [
        ...
        'wirelesslan_count' => 'getWirelesslanCount',
        '_depth' => 'getDepth'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('wirelesslan_count', $data ?? [], 0);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['wirelesslan_count'] === null) {
            $invalidProperties[] = "'wirelesslan_count' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WirelessLANGroup., must be smaller than or equal to 100.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WirelessLANGroup., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling WirelessLANGroup., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
     ...
     * Gets parent
     *
     * @return \OpenAPI\Client\Model\NestedWirelessLANGroup|null
     */
     ...
     * Sets parent
     *
     * @param \OpenAPI\Client\Model\NestedWirelessLANGroup|null $parent parent
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WirelessLANGroup., must be smaller than or equal to 200.');
        }
    ...
    /**
     * Gets wirelesslan_count
     *
     * @return int
     */
    public function getWirelesslanCount()
    {
        return $this->container['wirelesslan_count'];
    }

    /**
     * Sets wirelesslan_count
     *
     * @param int $wirelesslan_count wirelesslan_count
     *
     * @return self
     */
    public function setWirelesslanCount($wirelesslan_count)
    {
        if (is_null($wirelesslan_count)) {
            throw new \InvalidArgumentException('non-nullable wirelesslan_count cannot be null');
        }
        $this->container['wirelesslan_count'] = $wirelesslan_count;
