...
/**
 * WritableCustomFieldRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableCustomFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableCustomFieldRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableCustomFieldRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableCustomFieldRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-z0-9_]+$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling WritableCustomFieldRequest., must conform to the pattern /^[a-z0-9_]+$/.");
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 50)) {
            throw new \InvalidArgumentException('invalid length for $label when calling WritableCustomFieldRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setGroupName($group_name)
    {
        ...
        if ((mb_strlen($group_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $group_name when calling WritableCustomFieldRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableCustomFieldRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setSearchWeight($search_weight)
    {
        ...
        if (($search_weight > 32767)) {
            throw new \InvalidArgumentException('invalid value for $search_weight when calling WritableCustomFieldRequest., must be smaller than or equal to 32767.');
        }
        if (($search_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $search_weight when calling WritableCustomFieldRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 32767)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling WritableCustomFieldRequest., must be smaller than or equal to 32767.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling WritableCustomFieldRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setValidationMinimum($validation_minimum)
    {
        ...
        if (!is_null($validation_minimum) && ($validation_minimum > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $validation_minimum when calling WritableCustomFieldRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($validation_minimum) && ($validation_minimum < -9223372036854775808)) {
            throw new \InvalidArgumentException('invalid value for $validation_minimum when calling WritableCustomFieldRequest., must be bigger than or equal to -9223372036854775808.');
        }
    ...
    public function setValidationMaximum($validation_maximum)
    {
        ...
        if (!is_null($validation_maximum) && ($validation_maximum > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $validation_maximum when calling WritableCustomFieldRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($validation_maximum) && ($validation_maximum < -9223372036854775808)) {
            throw new \InvalidArgumentException('invalid value for $validation_maximum when calling WritableCustomFieldRequest., must be bigger than or equal to -9223372036854775808.');
        }
    ...
    public function setValidationRegex($validation_regex)
    {
        ...
        if ((mb_strlen($validation_regex) > 500)) {
            throw new \InvalidArgumentException('invalid length for $validation_regex when calling WritableCustomFieldRequest., must be smaller than or equal to 500.');
        }
