...
/**
 * PowerFeedSupply Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PowerFeedSupply implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerFeed_supply';
    ...
    public const LABEL_AC = 'AC';
    public const LABEL_DC = 'DC';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `ac` - AC * `dc` - DC
     *
     * @return self
     */
