...
/**
 * PowerOutletFeedLeg Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PowerOutletFeedLeg implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerOutlet_feed_leg';
    ...
    public const LABEL_A = 'A';
    public const LABEL_B = 'B';
    public const LABEL_C = 'C';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `A` - A * `B` - B * `C` - C
     *
     * @return self
     */
