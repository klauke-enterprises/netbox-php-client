...
class Contact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'display_url' => 'string',
        'display' => 'string',
        'group' => '\OpenAPI\Client\Model\BriefContactGroup',
        'name' => 'string',
        'title' => 'string',
        'phone' => 'string',
        'email' => 'string',
    ...
    */
     ...
     * Gets group
     *
     * @return \OpenAPI\Client\Model\BriefContactGroup|null
     */
     ...
     * Sets group
     *
     * @param \OpenAPI\Client\Model\BriefContactGroup|null $group group
     *
     * @return self
     */
    ...
    public function setPhone($phone)
    {
        ...
        if ((mb_strlen($phone) > 50)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling Contact., must be smaller than or equal to 50.');
        }
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) > 200)) {
            throw new \InvalidArgumentException('invalid length for $address when calling Contact., must be smaller than or equal to 200.');
        }
    ...
    public function setLink($link)
    {
        ...
        if ((mb_strlen($link) > 200)) {
            throw new \InvalidArgumentException('invalid length for $link when calling Contact., must be smaller than or equal to 200.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Contact., must be smaller than or equal to 200.');
        }
