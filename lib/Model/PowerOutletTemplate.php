...
/**
 * PowerOutletTemplate Class Doc Comment
 *
 * @category Class
 ...
 */
class PowerOutletTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerOutletTemplate';
    ...
    protected static $openAPITypes = [
        ...
        'power_port' => '\OpenAPI\Client\Model\PowerPortTemplate',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PowerOutletTemplate., must be smaller than or equal to 64.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PowerOutletTemplate., must be smaller than or equal to 64.');
        }
     ...
     * Gets power_port
     *
     * @return \OpenAPI\Client\Model\PowerPortTemplate|null
     */
     ...
     * Sets power_port
     *
     * @param \OpenAPI\Client\Model\PowerPortTemplate|null $power_port power_port
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PowerOutletTemplate., must be smaller than or equal to 200.');
        }
