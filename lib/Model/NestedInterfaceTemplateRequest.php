...
/**
 * NestedInterfaceTemplateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedInterfaceTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedInterfaceTemplateRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NestedInterfaceTemplateRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NestedInterfaceTemplateRequest., must be bigger than or equal to 1.');
        }
