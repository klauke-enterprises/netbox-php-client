...
/**
 * InterfaceTemplateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class InterfaceTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InterfaceTemplateRequest';
    ...
    protected static $openAPITypes = [
        ...
        'mgmt_only' => 'bool',
        'description' => 'string',
        'bridge' => '\OpenAPI\Client\Model\NestedInterfaceTemplateRequest',
        'poe_mode' => 'string',
        'poe_type' => 'string',
        'rf_role' => 'string'
    ];
    ...
    public const POE_MODE_NULL = 'null';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InterfaceTemplateRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InterfaceTemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling InterfaceTemplateRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InterfaceTemplateRequest., must be smaller than or equal to 200.');
        }
     ...
     * Gets bridge
     *
     * @return \OpenAPI\Client\Model\NestedInterfaceTemplateRequest|null
     */
     ...
     * Sets bridge
     *
     * @param \OpenAPI\Client\Model\NestedInterfaceTemplateRequest|null $bridge bridge
     *
     * @return self
     */
    ...
    public function setPoeType($poe_type)
    {
        ...
        $allowedValues = $this->getPoeTypeAllowableValues();
        if (!is_null($poe_type) && !in_array($poe_type, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'poe_type', must be one of '%s'",
                    $poe_type,
    ...
    public function setRfRole($rf_role)
    {
        ...
        $allowedValues = $this->getRfRoleAllowableValues();
        if (!is_null($rf_role) && !in_array($rf_role, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'rf_role', must be one of '%s'",
                    $rf_role,
