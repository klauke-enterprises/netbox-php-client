...
/**
 * WritableIKEProposalRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableIKEProposalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableIKEProposalRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableIKEProposalRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableIKEProposalRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableIKEProposalRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setGroup($group)
    {
        ...
        if (($group > 32767)) {
            throw new \InvalidArgumentException('invalid value for $group when calling WritableIKEProposalRequest., must be smaller than or equal to 32767.');
        }
        if (($group < 0)) {
            throw new \InvalidArgumentException('invalid value for $group when calling WritableIKEProposalRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setSaLifetime($sa_lifetime)
    {
        ...
        if (!is_null($sa_lifetime) && ($sa_lifetime > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime when calling WritableIKEProposalRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($sa_lifetime) && ($sa_lifetime < 0)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime when calling WritableIKEProposalRequest., must be bigger than or equal to 0.');
        }
