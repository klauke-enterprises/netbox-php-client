 ...
 */
class Cable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Cable';
    ...
    protected static $openAPITypes = [
        ...
        'display' => 'string',
        'type' => 'string',
        'a_terminations' => '\OpenAPI\Client\Model\GenericObject[]',
        'b_terminations' => '\OpenAPI\Client\Model\GenericObject[]',
        'status' => '\OpenAPI\Client\Model\CableStatus',
        'tenant' => '\OpenAPI\Client\Model\BriefTenant',
        'label' => 'string',
        'color' => 'string',
        'length' => 'float',
        'length_unit' => '\OpenAPI\Client\Model\CableLengthUnit',
        'description' => 'string',
        'comments' => 'string',
    ...
    */
     ...
     * Gets a_terminations
     *
     * @return \OpenAPI\Client\Model\GenericObject[]|null
     */
     ...
     * Sets a_terminations
     *
     * @param \OpenAPI\Client\Model\GenericObject[]|null $a_terminations a_terminations
     *
     * @return self
     */
     ...
     * Sets b_terminations
     *
     * @param \OpenAPI\Client\Model\GenericObject[]|null $b_terminations b_terminations
     *
     * @return self
     */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 100)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Cable., must be smaller than or equal to 100.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((mb_strlen($color) > 6)) {
            throw new \InvalidArgumentException('invalid length for $color when calling Cable., must be smaller than or equal to 6.');
        }
        if ((!preg_match("/^[0-9a-f]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling Cable., must conform to the pattern /^[0-9a-f]{6}$/.");
        }
    ...
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $length when calling Cable., must be smaller than 1000000.');
        }
        if (!is_null($length) && ($length <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $length when calling Cable., must be bigger than -1000000.');
        }
     ...
     * Gets length_unit
     *
     * @return \OpenAPI\Client\Model\CableLengthUnit|null
     */
     ...
     * Sets length_unit
     *
     * @param \OpenAPI\Client\Model\CableLengthUnit|null $length_unit length_unit
     *
     * @return self
     */
    public function setLengthUnit($length_unit)
    {
        if (is_null($length_unit)) {
            array_push($this->openAPINullablesSetToNull, 'length_unit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('length_unit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Cable., must be smaller than or equal to 200.');
        }
