...
/**
 * RackOuterUnit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RackOuterUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Rack_outer_unit';
    ...
    public const LABEL_MILLIMETERS = 'Millimeters';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `mm` - Millimeters * `in` - Inches
     *
     * @return self
     */
