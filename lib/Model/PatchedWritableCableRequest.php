...
/**
 * PatchedWritableCableRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableCableRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableCableRequest';
    ...
    */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 100)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PatchedWritableCableRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((mb_strlen($color) > 6)) {
            throw new \InvalidArgumentException('invalid length for $color when calling PatchedWritableCableRequest., must be smaller than or equal to 6.');
        }
        if ((!preg_match("/^[0-9a-f]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling PatchedWritableCableRequest., must conform to the pattern /^[0-9a-f]{6}$/.");
        }
    ...
    public function setLength($length)
    {
        ...
        if (!is_null($length) && ($length >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $length when calling PatchedWritableCableRequest., must be smaller than 1000000.');
        }
        if (!is_null($length) && ($length <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $length when calling PatchedWritableCableRequest., must be bigger than -1000000.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableCableRequest., must be smaller than or equal to 200.');
        }
