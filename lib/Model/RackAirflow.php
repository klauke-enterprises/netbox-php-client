 ...
 */
class RackAirflow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Rack_airflow';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `front-to-rear` - Front to rear * `rear-to-front` - Rear to front
     *
     * @return self
     */
