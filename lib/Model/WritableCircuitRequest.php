...
/**
 * WritableCircuitRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableCircuitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableCircuitRequest';
    ...
    protected static $openAPITypes = [
        ...
        'provider_account' => '\OpenAPI\Client\Model\BriefProviderAccountRequest',
        'type' => '\OpenAPI\Client\Model\BriefCircuitTypeRequest',
        'status' => 'string',
        ...
        'assignments' => '\OpenAPI\Client\Model\BriefCircuitGroupAssignmentSerializerRequest[]'
    ];
    ...
    */
    ...
    public function setCid($cid)
    {
        ...
        if ((mb_strlen($cid) > 100)) {
            throw new \InvalidArgumentException('invalid length for $cid when calling WritableCircuitRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($cid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cid when calling WritableCircuitRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\BriefProviderAccountRequest|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BriefProviderAccountRequest|null $provider_account provider_account
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\BriefCircuitTypeRequest
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\BriefCircuitTypeRequest $type type
     *
     * @return self
     */
    ...
    public function setCommitRate($commit_rate)
    {
        ...
        if (!is_null($commit_rate) && ($commit_rate > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $commit_rate when calling WritableCircuitRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($commit_rate) && ($commit_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $commit_rate when calling WritableCircuitRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableCircuitRequest., must be smaller than or equal to 200.');
        }
     ...
     * Gets assignments
     *
     * @return \OpenAPI\Client\Model\BriefCircuitGroupAssignmentSerializerRequest[]|null
     */
     ...
     * Sets assignments
     *
     * @param \OpenAPI\Client\Model\BriefCircuitGroupAssignmentSerializerRequest[]|null $assignments assignments
     *
     * @return self
     */
