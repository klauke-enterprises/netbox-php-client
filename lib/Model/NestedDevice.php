...
/**
 * NestedDevice Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedDevice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedDevice';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NestedDevice., must be smaller than or equal to 64.');
        }
