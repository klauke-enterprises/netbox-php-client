...
/**
 * InterfaceTemplateRfRole Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InterfaceTemplateRfRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InterfaceTemplate_rf_role';
    ...
    public const VALUE_AP = 'ap';
    public const VALUE_STATION = 'station';
    public const VALUE_EMPTY = '';
    public const VALUE_NULL = 'null';
    public const LABEL_ACCESS_POINT = 'Access point';
    public const LABEL_STATION = 'Station';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `ap` - Access point * `station` - Station
     *
     * @return self
     */
