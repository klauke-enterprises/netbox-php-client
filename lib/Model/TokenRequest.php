...
class TokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) > 40)) {
            throw new \InvalidArgumentException('invalid length for $key when calling TokenRequest., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($key) < 40)) {
            throw new \InvalidArgumentException('invalid length for $key when calling TokenRequest., must be bigger than or equal to 40.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TokenRequest., must be smaller than or equal to 200.');
        }
