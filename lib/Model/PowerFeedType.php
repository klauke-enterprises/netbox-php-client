...
/**
 * PowerFeedType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PowerFeedType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerFeed_type';
    ...
    public const VALUE_REDUNDANT = 'redundant';
    public const LABEL_PRIMARY = 'Primary';
    public const LABEL_REDUNDANT = 'Redundant';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `primary` - Primary * `redundant` - Redundant
     *
     * @return self
     */
