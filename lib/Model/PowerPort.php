 ...
 */
class PowerPort implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerPort';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'label' => 'string',
        'type' => '\OpenAPI\Client\Model\PowerPortType',
        'maximum_draw' => 'int',
        'allocated_draw' => 'int',
        'description' => 'string',
        'mark_connected' => 'bool',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PowerPort., must be smaller than or equal to 64.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PowerPort., must be smaller than or equal to 64.');
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\PowerPortType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\PowerPortType|null $type type
     *
     * @return self
     */
    ...
    public function setMaximumDraw($maximum_draw)
    {
        ...
        if (!is_null($maximum_draw) && ($maximum_draw > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $maximum_draw when calling PowerPort., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($maximum_draw) && ($maximum_draw < 1)) {
            throw new \InvalidArgumentException('invalid value for $maximum_draw when calling PowerPort., must be bigger than or equal to 1.');
        }
    ...
    public function setAllocatedDraw($allocated_draw)
    {
        ...
        if (!is_null($allocated_draw) && ($allocated_draw > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $allocated_draw when calling PowerPort., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($allocated_draw) && ($allocated_draw < 1)) {
            throw new \InvalidArgumentException('invalid value for $allocated_draw when calling PowerPort., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PowerPort., must be smaller than or equal to 200.');
        }
