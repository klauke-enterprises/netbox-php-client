 ...
 */
class DataSourceStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataSource_status';
    ...
    public const VALUE__NEW = 'new';
    public const VALUE_QUEUED = 'queued';
    public const VALUE_SYNCING = 'syncing';
    public const VALUE_COMPLETED = 'completed';
    public const VALUE_FAILED = 'failed';
    public const LABEL__NEW = 'New';
    public const LABEL_QUEUED = 'Queued';
    public const LABEL_SYNCING = 'Syncing';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `new` - New * `queued` - Queued * `syncing` - Syncing * `completed` - Completed * `failed` - Failed
     *
     * @return self
     */
