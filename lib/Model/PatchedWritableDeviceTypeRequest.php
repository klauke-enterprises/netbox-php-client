...
/**
 * PatchedWritableDeviceTypeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableDeviceTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableDeviceTypeRequest';
    ...
    */
    ...
    public function setModel($model)
    {
        ...
        if ((mb_strlen($model) > 100)) {
            throw new \InvalidArgumentException('invalid length for $model when calling PatchedWritableDeviceTypeRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($model) < 1)) {
            throw new \InvalidArgumentException('invalid length for $model when calling PatchedWritableDeviceTypeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling PatchedWritableDeviceTypeRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling PatchedWritableDeviceTypeRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling PatchedWritableDeviceTypeRequest., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
    ...
    public function setPartNumber($part_number)
    {
        ...
        if ((mb_strlen($part_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $part_number when calling PatchedWritableDeviceTypeRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setUHeight($u_height)
    {
        ...
        if (($u_height >= 1000)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling PatchedWritableDeviceTypeRequest., must be smaller than 1000.');
        }
        if (($u_height < 0)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling PatchedWritableDeviceTypeRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedWritableDeviceTypeRequest., must be smaller than 1000000.');
        }
        if (!is_null($weight) && ($weight <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedWritableDeviceTypeRequest., must be bigger than -1000000.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableDeviceTypeRequest., must be smaller than or equal to 200.');
        }
