...
/**
 * PatchedWritableRackTypeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableRackTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableRackTypeRequest';
    ...
    */
    ...
    public function setModel($model)
    {
        ...
        if ((mb_strlen($model) > 100)) {
            throw new \InvalidArgumentException('invalid length for $model when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($model) < 1)) {
            throw new \InvalidArgumentException('invalid length for $model when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling PatchedWritableRackTypeRequest., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setWidth($width)
    {
        ...
        if (($width > 32767)) {
            throw new \InvalidArgumentException('invalid value for $width when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 32767.');
        }
        if (($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setUHeight($u_height)
    {
        ...
        if (($u_height > 100)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 100.');
        }
        if (($u_height < 1)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setStartingUnit($starting_unit)
    {
        ...
        if (($starting_unit > 32767)) {
            throw new \InvalidArgumentException('invalid value for $starting_unit when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 32767.');
        }
        if (($starting_unit < 1)) {
            throw new \InvalidArgumentException('invalid value for $starting_unit when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setOuterWidth($outer_width)
    {
        ...
        if (!is_null($outer_width) && ($outer_width > 32767)) {
            throw new \InvalidArgumentException('invalid value for $outer_width when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($outer_width) && ($outer_width < 0)) {
            throw new \InvalidArgumentException('invalid value for $outer_width when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setOuterDepth($outer_depth)
    {
        ...
        if (!is_null($outer_depth) && ($outer_depth > 32767)) {
            throw new \InvalidArgumentException('invalid value for $outer_depth when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($outer_depth) && ($outer_depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $outer_depth when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedWritableRackTypeRequest., must be smaller than 1000000.');
        }
        if (!is_null($weight) && ($weight <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedWritableRackTypeRequest., must be bigger than -1000000.');
        }
    ...
    public function setMaxWeight($max_weight)
    {
        ...
        if (!is_null($max_weight) && ($max_weight > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $max_weight when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($max_weight) && ($max_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_weight when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMountingDepth($mounting_depth)
    {
        ...
        if (!is_null($mounting_depth) && ($mounting_depth > 32767)) {
            throw new \InvalidArgumentException('invalid value for $mounting_depth when calling PatchedWritableRackTypeRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($mounting_depth) && ($mounting_depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $mounting_depth when calling PatchedWritableRackTypeRequest., must be bigger than or equal to 0.');
        }
