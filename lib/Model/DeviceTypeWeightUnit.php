...
/**
 * DeviceTypeWeightUnit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeviceTypeWeightUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceType_weight_unit';
    ...
    public const VALUE_OZ = 'oz';
    public const VALUE_EMPTY = '';
    public const VALUE_NULL = 'null';
    public const LABEL_KILOGRAMS = 'Kilograms';
    public const LABEL_GRAMS = 'Grams';
    public const LABEL_POUNDS = 'Pounds';
    public const LABEL_OUNCES = 'Ounces';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `kg` - Kilograms * `g` - Grams * `lb` - Pounds * `oz` - Ounces
     *
     * @return self
     */
