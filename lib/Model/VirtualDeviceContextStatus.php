...
/**
 * VirtualDeviceContextStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VirtualDeviceContextStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualDeviceContext_status';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `active` - Active * `planned` - Planned * `offline` - Offline
     *
     * @return self
     */
