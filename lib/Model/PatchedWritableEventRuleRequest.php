...
/**
 * PatchedWritableEventRuleRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableEventRuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableEventRuleRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableEventRuleRequest., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableEventRuleRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets event_types
     *
     * @param string[]|null $event_types The types of event which will trigger this rule.
     *
     * @return self
     */
     ...
     * Sets action_type
     *
     * @param string|null $action_type * `webhook` - Webhook * `script` - Script * `notification` - Notification
     *
     * @return self
     */
     ...
     *
     * @param string|null $action_object_type action_object_type
     *
     * @return self
     */
    ...
    public function setActionObjectId($action_object_id)
    {
        ...
        if (!is_null($action_object_id) && ($action_object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $action_object_id when calling PatchedWritableEventRuleRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($action_object_id) && ($action_object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $action_object_id when calling PatchedWritableEventRuleRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableEventRuleRequest., must be smaller than or equal to 200.');
        }
