...
/**
 * InterfaceDuplex Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InterfaceDuplex implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Interface_duplex';
    ...
    public const VALUE_HALF = 'half';
    public const VALUE_FULL = 'full';
    public const VALUE_AUTO = 'auto';
    public const VALUE_EMPTY = '';
    public const VALUE_NULL = 'null';
    public const LABEL_HALF = 'Half';
    public const LABEL_FULL = 'Full';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `half` - Half * `full` - Full * `auto` - Auto
     *
     * @return self
     */
