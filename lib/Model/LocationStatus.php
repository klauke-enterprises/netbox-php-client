 ...
 */
class LocationStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Location_status';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `planned` - Planned * `staging` - Staging * `active` - Active * `decommissioning` - Decommissioning * `retired` - Retired
     *
     * @return self
     */
