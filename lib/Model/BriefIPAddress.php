...
/**
 * BriefIPAddress Class Doc Comment
 *
 * @category Class
 ...
 */
class BriefIPAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BriefIPAddress';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BriefIPAddress., must be smaller than or equal to 200.');
        }
