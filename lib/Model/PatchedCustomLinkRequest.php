...
/**
 * PatchedCustomLinkRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedCustomLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedCustomLinkRequest';
    ...
    public const BUTTON_CLASS__DEFAULT = 'default';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['link_url']) && (mb_strlen($this->container['link_url']) < 1)) {
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedCustomLinkRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedCustomLinkRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets link_text
     *
     * @param string|null $link_text Jinja2 template code for link text
     *
     * @return self
     */
    public function setLinkText($link_text)
    {
        ...
        if ((mb_strlen($link_text) < 1)) {
            throw new \InvalidArgumentException('invalid length for $link_text when calling PatchedCustomLinkRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets link_url
     *
     * @param string|null $link_url Jinja2 template code for link URL
     *
     * @return self
     */
    public function setLinkUrl($link_url)
    {
        ...
        if ((mb_strlen($link_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $link_url when calling PatchedCustomLinkRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 32767)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedCustomLinkRequest., must be smaller than or equal to 32767.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedCustomLinkRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupName($group_name)
    {
        ...
        if ((mb_strlen($group_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $group_name when calling PatchedCustomLinkRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets button_class
     *
     * @param string|null $button_class The class of the first link in a group will be used for the dropdown button  * `default` - Default * `blue` - Blue * `indigo` - Indigo * `purple` - Purple * `pink` - Pink * `red` - Red * `orange` - Orange * `yellow` - Yellow * `green` - Green * `teal` - Teal * `cyan` - Cyan * `gray` - Gray * `black` - Black * `white` - White * `ghost-dark` - Link
     *
     * @return self
     */
