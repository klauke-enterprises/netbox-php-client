...
/**
 * NestedInterface Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedInterface';
    ...
    protected static $openAPITypes = [
        ...
        'url' => 'string',
        'display' => 'string',
        'device' => '\OpenAPI\Client\Model\NestedDevice',
        'name' => 'string',
        'cable' => 'int',
        '_occupied' => 'bool'
    ];
    ...
    */
     ...
     * Sets device
     *
     * @param \OpenAPI\Client\Model\NestedDevice $device device
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NestedInterface., must be smaller than or equal to 64.');
        }
