...
/**
 * PatchedProviderRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedProviderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedProviderRequest';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Full name of the provider
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedProviderRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedProviderRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling PatchedProviderRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling PatchedProviderRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling PatchedProviderRequest., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedProviderRequest., must be smaller than or equal to 200.');
        }
