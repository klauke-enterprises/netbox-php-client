...
/**
 * WirelessLANStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WirelessLANStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WirelessLAN_status';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `active` - Active * `reserved` - Reserved * `disabled` - Disabled * `deprecated` - Deprecated
     *
     * @return self
     */
