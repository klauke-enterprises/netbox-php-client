...
/**
 * BriefJobStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BriefJobStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BriefJob_status';
    ...
    public const VALUE_SCHEDULED = 'scheduled';
    public const VALUE_RUNNING = 'running';
    public const VALUE_COMPLETED = 'completed';
    public const VALUE_ERRORED = 'errored';
    public const VALUE_FAILED = 'failed';
    public const LABEL_PENDING = 'Pending';
    public const LABEL_SCHEDULED = 'Scheduled';
    public const LABEL_RUNNING = 'Running';
    public const LABEL_COMPLETED = 'Completed';
    public const LABEL_ERRORED = 'Errored';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `pending` - Pending * `scheduled` - Scheduled * `running` - Running * `completed` - Completed * `errored` - Errored * `failed` - Failed
     *
     * @return self
     */
