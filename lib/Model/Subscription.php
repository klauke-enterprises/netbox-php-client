    ...
    */
    ...
    public function setObjectId($object_id)
    {
        ...
        if (($object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling Subscription., must be smaller than or equal to 9223372036854775807.');
        }
        if (($object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling Subscription., must be bigger than or equal to 0.');
        }
