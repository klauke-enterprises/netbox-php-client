 ...
 */
class RIR implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RIR';
    ...
    protected static $setters = [
        ...
        'aggregate_count' => 'setAggregateCount'
    ];
    ...
    protected static $getters = [
        ...
        'aggregate_count' => 'getAggregateCount'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('aggregate_count', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['aggregate_count'] === null) {
            $invalidProperties[] = "'aggregate_count' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RIR., must be smaller than or equal to 100.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling RIR., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling RIR., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
     ...
     * Sets is_private
     *
     * @param bool|null $is_private IP space managed by this RIR is considered private
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RIR., must be smaller than or equal to 200.');
        }
    ...
    /**
     * Gets aggregate_count
     *
     * @return int
     */
    public function getAggregateCount()
    {
        return $this->container['aggregate_count'];
    }

    /**
     * Sets aggregate_count
     *
     * @param int $aggregate_count aggregate_count
     *
     * @return self
     */
    public function setAggregateCount($aggregate_count)
    {
        if (is_null($aggregate_count)) {
            throw new \InvalidArgumentException('non-nullable aggregate_count cannot be null');
        }
        $this->container['aggregate_count'] = $aggregate_count;
