...
/**
 * ServiceProtocol Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ServiceProtocol implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Service_protocol';
    ...
    public const VALUE_TCP = 'tcp';
    public const VALUE_UDP = 'udp';
    public const VALUE_SCTP = 'sctp';
    public const LABEL_TCP = 'TCP';
    public const LABEL_UDP = 'UDP';
    public const LABEL_SCTP = 'SCTP';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `tcp` - TCP * `udp` - UDP * `sctp` - SCTP
     *
     * @return self
     */
