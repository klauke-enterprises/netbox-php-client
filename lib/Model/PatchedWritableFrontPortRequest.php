...
/**
 * PatchedWritableFrontPortRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableFrontPortRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableFrontPortRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableFrontPortRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableFrontPortRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PatchedWritableFrontPortRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((mb_strlen($color) > 6)) {
            throw new \InvalidArgumentException('invalid length for $color when calling PatchedWritableFrontPortRequest., must be smaller than or equal to 6.');
        }
        if ((!preg_match("/^[0-9a-f]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling PatchedWritableFrontPortRequest., must conform to the pattern /^[0-9a-f]{6}$/.");
        }
     ...
     * Sets rear_port
     *
     * @param int|null $rear_port rear_port
     *
     * @return self
     */
    ...
    public function setRearPortPosition($rear_port_position)
    {
        ...
        if (($rear_port_position > 1024)) {
            throw new \InvalidArgumentException('invalid value for $rear_port_position when calling PatchedWritableFrontPortRequest., must be smaller than or equal to 1024.');
        }
        if (($rear_port_position < 1)) {
            throw new \InvalidArgumentException('invalid value for $rear_port_position when calling PatchedWritableFrontPortRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableFrontPortRequest., must be smaller than or equal to 200.');
        }
