...
/**
 * PrefixRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PrefixRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PrefixRequest';
    ...
    */
    ...
    public function setPrefix($prefix)
    {
        ...
        if ((mb_strlen($prefix) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling PrefixRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param string|null $status * `container` - Container * `active` - Active * `reserved` - Reserved * `deprecated` - Deprecated
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PrefixRequest., must be smaller than or equal to 200.');
        }
