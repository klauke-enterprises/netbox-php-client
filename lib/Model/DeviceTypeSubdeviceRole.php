...
/**
 * DeviceTypeSubdeviceRole Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DeviceTypeSubdeviceRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceType_subdevice_role';
    ...
    public const VALUE_PARENT = 'parent';
    public const VALUE_CHILD = 'child';
    public const VALUE_EMPTY = '';
    public const VALUE_NULL = 'null';
    public const LABEL_PARENT = 'Parent';
    public const LABEL_CHILD = 'Child';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `parent` - Parent * `child` - Child
     *
     * @return self
     */
