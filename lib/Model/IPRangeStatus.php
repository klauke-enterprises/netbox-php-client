...
/**
 * IPRangeStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IPRangeStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPRange_status';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `active` - Active * `reserved` - Reserved * `deprecated` - Deprecated
     *
     * @return self
     */
