...
/**
 * PowerFeedPhase Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PowerFeedPhase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerFeed_phase';
    ...
    public const VALUE_SINGLE_PHASE = 'single-phase';
    public const VALUE_THREE_PHASE = 'three-phase';
    public const LABEL_SINGLE_PHASE = 'Single phase';
    public const LABEL_THREE_PHASE = 'Three-phase';
    ...
    {
        return [
            self::VALUE_SINGLE_PHASE,
            self::VALUE_THREE_PHASE,
        ];
    }
    ...
    {
        return [
            self::LABEL_SINGLE_PHASE,
            self::LABEL_THREE_PHASE,
        ];
    }
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `single-phase` - Single phase * `three-phase` - Three-phase
     *
     * @return self
     */
