...
/**
 * BriefUserRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class BriefUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BriefUserRequest';
    ...
    */
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 150)) {
            throw new \InvalidArgumentException('invalid length for $username when calling BriefUserRequest., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling BriefUserRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\w.@+-]+$/", ObjectSerializer::toString($username)))) {
            throw new \InvalidArgumentException("invalid value for \$username when calling BriefUserRequest., must conform to the pattern /^[\\w.@+-]+$/.");
        }
