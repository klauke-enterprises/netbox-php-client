 ...
 */
class RouteTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RouteTarget';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 21)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RouteTarget., must be smaller than or equal to 21.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RouteTarget., must be smaller than or equal to 200.');
        }
