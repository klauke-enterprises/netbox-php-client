...
class DataSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'display' => 'string',
        'name' => 'string',
        'type' => '\OpenAPI\Client\Model\DataSourceType',
        'source_url' => 'string',
        'enabled' => 'bool',
        'status' => '\OpenAPI\Client\Model\DataSourceStatus',
        'description' => 'string',
        'parameters' => 'mixed',
        'ignore_rules' => 'string',
        'comments' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['last_synced'] === null) {
            $invalidProperties[] = "'last_synced' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DataSource., must be smaller than or equal to 100.');
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\DataSourceType
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\DataSourceType $type type
     *
     * @return self
     */
    ...
    public function setSourceUrl($source_url)
    {
        ...
        if ((mb_strlen($source_url) > 200)) {
            throw new \InvalidArgumentException('invalid length for $source_url when calling DataSource., must be smaller than or equal to 200.');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\DataSourceStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\DataSourceStatus $status status
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DataSource., must be smaller than or equal to 200.');
        }
     ...
     * Sets last_synced
     *
     * @param \DateTime $last_synced last_synced
     *
     * @return self
     */
    public function setLastSynced($last_synced)
    {
        if (is_null($last_synced)) {
            array_push($this->openAPINullablesSetToNull, 'last_synced');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_synced', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
