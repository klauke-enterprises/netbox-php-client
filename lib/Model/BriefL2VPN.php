 ...
 */
class BriefL2VPN implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BriefL2VPN';
    ...
    */
    ...
    public function setIdentifier($identifier)
    {
        ...
        if (!is_null($identifier) && ($identifier > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $identifier when calling BriefL2VPN., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($identifier) && ($identifier < -9223372036854775808)) {
            throw new \InvalidArgumentException('invalid value for $identifier when calling BriefL2VPN., must be bigger than or equal to -9223372036854775808.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling BriefL2VPN., must be smaller than or equal to 100.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling BriefL2VPN., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling BriefL2VPN., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BriefL2VPN., must be smaller than or equal to 200.');
        }
