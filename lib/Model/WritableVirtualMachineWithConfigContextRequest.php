...
/**
 * WritableVirtualMachineWithConfigContextRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableVirtualMachineWithConfigContextRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableVirtualMachineWithConfigContextRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableVirtualMachineWithConfigContextRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableVirtualMachineWithConfigContextRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSerial($serial)
    {
        ...
        if ((mb_strlen($serial) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial when calling WritableVirtualMachineWithConfigContextRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setVcpus($vcpus)
    {
        ...
        if (!is_null($vcpus) && ($vcpus >= 10000)) {
            throw new \InvalidArgumentException('invalid value for $vcpus when calling WritableVirtualMachineWithConfigContextRequest., must be smaller than 10000.');
        }
        if (!is_null($vcpus) && ($vcpus < 0.01)) {
            throw new \InvalidArgumentException('invalid value for $vcpus when calling WritableVirtualMachineWithConfigContextRequest., must be bigger than or equal to 0.01.');
        }
    ...
    public function setMemory($memory)
    {
        ...
        if (!is_null($memory) && ($memory > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $memory when calling WritableVirtualMachineWithConfigContextRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($memory) && ($memory < 0)) {
            throw new \InvalidArgumentException('invalid value for $memory when calling WritableVirtualMachineWithConfigContextRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDisk($disk)
    {
        ...
        if (!is_null($disk) && ($disk > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $disk when calling WritableVirtualMachineWithConfigContextRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($disk) && ($disk < 0)) {
            throw new \InvalidArgumentException('invalid value for $disk when calling WritableVirtualMachineWithConfigContextRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableVirtualMachineWithConfigContextRequest., must be smaller than or equal to 200.');
        }
