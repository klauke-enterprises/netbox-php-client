...
/**
 * EventRuleActionType Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class EventRuleActionType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventRule_action_type';
    ...
    public const VALUE_SCRIPT = 'script';
    public const VALUE_NOTIFICATION = 'notification';
    public const LABEL_WEBHOOK = 'Webhook';
    public const LABEL_SCRIPT = 'Script';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `webhook` - Webhook * `script` - Script * `notification` - Notification
     *
     * @return self
     */
