 ...
 */
class ModuleBay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModuleBay';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'installed_module' => '\OpenAPI\Client\Model\BriefModule',
        'label' => 'string',
        'position' => 'string',
        'description' => 'string',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ModuleBay., must be smaller than or equal to 64.');
        }
     ...
     *
     * @param \OpenAPI\Client\Model\BriefModule|null $installed_module installed_module
     *
     * @return self
     */
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ModuleBay., must be smaller than or equal to 64.');
        }
    ...
    public function setPosition($position)
    {
        ...
        if ((mb_strlen($position) > 30)) {
            throw new \InvalidArgumentException('invalid length for $position when calling ModuleBay., must be smaller than or equal to 30.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ModuleBay., must be smaller than or equal to 200.');
        }
