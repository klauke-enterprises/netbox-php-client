 ...
 */
class ProviderAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProviderAccount';
    ...
    */
     ...
     * Sets provider
     *
     * @param \OpenAPI\Client\Model\Provider $provider provider
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProviderAccount., must be smaller than or equal to 100.');
        }
    ...
    public function setAccount($account)
    {
        ...
        if ((mb_strlen($account) > 100)) {
            throw new \InvalidArgumentException('invalid length for $account when calling ProviderAccount., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ProviderAccount., must be smaller than or equal to 200.');
        }
