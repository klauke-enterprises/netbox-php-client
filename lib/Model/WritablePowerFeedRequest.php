...
/**
 * WritablePowerFeedRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritablePowerFeedRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritablePowerFeedRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritablePowerFeedRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritablePowerFeedRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setVoltage($voltage)
    {
        ...
        if (($voltage > 32767)) {
            throw new \InvalidArgumentException('invalid value for $voltage when calling WritablePowerFeedRequest., must be smaller than or equal to 32767.');
        }
        if (($voltage < -32768)) {
            throw new \InvalidArgumentException('invalid value for $voltage when calling WritablePowerFeedRequest., must be bigger than or equal to -32768.');
        }
    ...
    public function setAmperage($amperage)
    {
        ...
        if (($amperage > 32767)) {
            throw new \InvalidArgumentException('invalid value for $amperage when calling WritablePowerFeedRequest., must be smaller than or equal to 32767.');
        }
        if (($amperage < 1)) {
            throw new \InvalidArgumentException('invalid value for $amperage when calling WritablePowerFeedRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMaxUtilization($max_utilization)
    {
        ...
        if (($max_utilization > 100)) {
            throw new \InvalidArgumentException('invalid value for $max_utilization when calling WritablePowerFeedRequest., must be smaller than or equal to 100.');
        }
        if (($max_utilization < 1)) {
            throw new \InvalidArgumentException('invalid value for $max_utilization when calling WritablePowerFeedRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritablePowerFeedRequest., must be smaller than or equal to 200.');
        }
