...
/**
 * CustomFieldFilterLogic Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldFilterLogic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomField_filter_logic';
    ...
    public const VALUE_LOOSE = 'loose';
    public const VALUE_EXACT = 'exact';
    public const LABEL_DISABLED = 'Disabled';
    public const LABEL_LOOSE = 'Loose';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `disabled` - Disabled * `loose` - Loose * `exact` - Exact
     *
     * @return self
     */
