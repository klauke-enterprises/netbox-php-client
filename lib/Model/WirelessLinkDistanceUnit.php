...
/**
 * WirelessLinkDistanceUnit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WirelessLinkDistanceUnit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WirelessLink_distance_unit';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `km` - Kilometers * `m` - Meters * `mi` - Miles * `ft` - Feet
     *
     * @return self
     */
