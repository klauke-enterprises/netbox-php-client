...
/**
 * WritableSiteRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableSiteRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableSiteRequest';
    ...
    protected static $openAPITypes = [
        ...
        'slug' => 'string',
        'status' => 'string',
        'region' => '\OpenAPI\Client\Model\RegionRequest',
        'group' => '\OpenAPI\Client\Model\SiteGroupRequest',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableSiteRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableSiteRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WritableSiteRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling WritableSiteRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling WritableSiteRequest., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
     ...
     * Gets region
     *
     * @return \OpenAPI\Client\Model\RegionRequest|null
     */
     ...
     * Sets region
     *
     * @param \OpenAPI\Client\Model\RegionRequest|null $region region
     *
     * @return self
     */
     ...
     * Gets group
     *
     * @return \OpenAPI\Client\Model\SiteGroupRequest|null
     */
     ...
     * Sets group
     *
     * @param \OpenAPI\Client\Model\SiteGroupRequest|null $group group
     *
     * @return self
     */
    ...
    public function setFacility($facility)
    {
        ...
        if ((mb_strlen($facility) > 50)) {
            throw new \InvalidArgumentException('invalid length for $facility when calling WritableSiteRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setTimeZone($time_zone)
    {
        ...
        if (!is_null($time_zone) && (mb_strlen($time_zone) < 1)) {
            throw new \InvalidArgumentException('invalid length for $time_zone when calling WritableSiteRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableSiteRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setPhysicalAddress($physical_address)
    {
        ...
        if ((mb_strlen($physical_address) > 200)) {
            throw new \InvalidArgumentException('invalid length for $physical_address when calling WritableSiteRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setShippingAddress($shipping_address)
    {
        ...
        if ((mb_strlen($shipping_address) > 200)) {
            throw new \InvalidArgumentException('invalid length for $shipping_address when calling WritableSiteRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setLatitude($latitude)
    {
        ...
        if (!is_null($latitude) && ($latitude >= 100)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling WritableSiteRequest., must be smaller than 100.');
        }
        if (!is_null($latitude) && ($latitude <= -100)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling WritableSiteRequest., must be bigger than -100.');
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if (!is_null($longitude) && ($longitude >= 1000)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling WritableSiteRequest., must be smaller than 1000.');
        }
        if (!is_null($longitude) && ($longitude <= -1000)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling WritableSiteRequest., must be bigger than -1000.');
        }
