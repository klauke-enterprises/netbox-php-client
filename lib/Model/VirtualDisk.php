 ...
 */
class VirtualDisk implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualDisk';
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\BriefVirtualMachine
     */
     ...
     *
     * @param \OpenAPI\Client\Model\BriefVirtualMachine $virtual_machine virtual_machine
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VirtualDisk., must be smaller than or equal to 64.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VirtualDisk., must be smaller than or equal to 200.');
        }
    ...
    public function setSize($size)
    {
        ...
        if (($size > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $size when calling VirtualDisk., must be smaller than or equal to 2147483647.');
        }
        if (($size < 0)) {
            throw new \InvalidArgumentException('invalid value for $size when calling VirtualDisk., must be bigger than or equal to 0.');
        }
