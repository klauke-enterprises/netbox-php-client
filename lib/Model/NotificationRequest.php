    ...
    */
    ...
    public function setObjectId($object_id)
    {
        ...
        if (($object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling NotificationRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (($object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling NotificationRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets user
     *
     * @return \OpenAPI\Client\Model\BriefUserRequest
     */
     ...
     * Sets user
     *
     * @param \OpenAPI\Client\Model\BriefUserRequest $user user
     *
     * @return self
     */
     ...
     * Sets event_type
     *
     * @param string $event_type * `object_created` - Object created * `object_updated` - Object updated * `object_deleted` - Object deleted * `job_started` - Job started * `job_completed` - Job completed * `job_failed` - Job failed * `job_errored` - Job errored
     *
     * @return self
     */
