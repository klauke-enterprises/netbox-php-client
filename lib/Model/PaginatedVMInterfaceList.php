...
/**
 * PaginatedVMInterfaceList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedVMInterfaceList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedVMInterfaceList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\VMInterface[]'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\VMInterface[] $results results
     *
     * @return self
     */
