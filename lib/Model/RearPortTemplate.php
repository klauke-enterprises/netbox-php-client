...
/**
 * RearPortTemplate Class Doc Comment
 *
 * @category Class
 ...
 */
class RearPortTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RearPortTemplate';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling RearPortTemplate., must be smaller than or equal to 64.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling RearPortTemplate., must be smaller than or equal to 64.');
        }
    ...
    public function setColor($color)
    {
        ...
        if ((mb_strlen($color) > 6)) {
            throw new \InvalidArgumentException('invalid length for $color when calling RearPortTemplate., must be smaller than or equal to 6.');
        }
        if ((!preg_match("/^[0-9a-f]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling RearPortTemplate., must conform to the pattern /^[0-9a-f]{6}$/.");
        }
    ...
    public function setPositions($positions)
    {
        ...
        if (($positions > 1024)) {
            throw new \InvalidArgumentException('invalid value for $positions when calling RearPortTemplate., must be smaller than or equal to 1024.');
        }
        if (($positions < 1)) {
            throw new \InvalidArgumentException('invalid value for $positions when calling RearPortTemplate., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling RearPortTemplate., must be smaller than or equal to 200.');
        }
