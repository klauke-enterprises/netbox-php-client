...
/**
 * PatchedWritableJournalEntryRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableJournalEntryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableJournalEntryRequest';
    ...
    */
    ...
    public function setAssignedObjectId($assigned_object_id)
    {
        ...
        if (($assigned_object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $assigned_object_id when calling PatchedWritableJournalEntryRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (($assigned_object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $assigned_object_id when calling PatchedWritableJournalEntryRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setComments($comments)
    {
        ...
        if ((mb_strlen($comments) < 1)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling PatchedWritableJournalEntryRequest., must be bigger than or equal to 1.');
        }
