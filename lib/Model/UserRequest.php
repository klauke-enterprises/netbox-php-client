    ...
    */
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) > 150)) {
            throw new \InvalidArgumentException('invalid length for $username when calling UserRequest., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling UserRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[\\w.@+-]+$/", ObjectSerializer::toString($username)))) {
            throw new \InvalidArgumentException("invalid value for \$username when calling UserRequest., must conform to the pattern /^[\\w.@+-]+$/.");
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 128)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserRequest., must be smaller than or equal to 128.');
        }
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling UserRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UserRequest., must be smaller than or equal to 150.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UserRequest., must be smaller than or equal to 150.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UserRequest., must be smaller than or equal to 254.');
        }
