 ...
 */
class L2VPN implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'L2VPN';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'slug' => 'string',
        'type' => '\OpenAPI\Client\Model\BriefL2VPNType',
    ...
    */
    ...
    public function setIdentifier($identifier)
    {
        ...
        if (!is_null($identifier) && ($identifier > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $identifier when calling L2VPN., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($identifier) && ($identifier < -9223372036854775808)) {
            throw new \InvalidArgumentException('invalid value for $identifier when calling L2VPN., must be bigger than or equal to -9223372036854775808.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling L2VPN., must be smaller than or equal to 100.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling L2VPN., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling L2VPN., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\BriefL2VPNType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\BriefL2VPNType|null $type type
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling L2VPN., must be smaller than or equal to 200.');
        }
