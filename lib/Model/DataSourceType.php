 ...
 */
class DataSourceType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataSource_type';
    ...
    public const VALUE_LOCAL = 'local';
    public const VALUE_GIT = 'git';
    public const VALUE_AMAZON_S3 = 'amazon-s3';
    public const LABEL________ = '---------';
    public const LABEL_LOCAL = 'Local';
    public const LABEL_GIT = 'Git';
    public const LABEL_AMAZON_S3 = 'Amazon S3';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `None` - --------- * `local` - Local * `git` - Git * `amazon-s3` - Amazon S3
     *
     * @return self
     */
