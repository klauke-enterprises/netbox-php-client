...
/**
 * ModuleBayTemplateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ModuleBayTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModuleBayTemplateRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ModuleBayTemplateRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ModuleBayTemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ModuleBayTemplateRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setPosition($position)
    {
        ...
        if ((mb_strlen($position) > 30)) {
            throw new \InvalidArgumentException('invalid length for $position when calling ModuleBayTemplateRequest., must be smaller than or equal to 30.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ModuleBayTemplateRequest., must be smaller than or equal to 200.');
        }
