...
class CircuitTermination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'url' => 'string',
        'display' => 'string',
        'circuit' => '\OpenAPI\Client\Model\Circuit',
        'term_side' => 'string',
        'site' => '\OpenAPI\Client\Model\Site',
        'provider_network' => '\OpenAPI\Client\Model\ProviderNetwork',
        'port_speed' => 'int',
        'upstream_speed' => 'int',
        'xconnect_id' => 'string',
        'pp_info' => 'string',
    ...
    */
     ...
     * Sets circuit
     *
     * @param \OpenAPI\Client\Model\Circuit $circuit circuit
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ProviderNetwork|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ProviderNetwork|null $provider_network provider_network
     *
     * @return self
     */
