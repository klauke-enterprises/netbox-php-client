...
/**
 * IKEPolicyVersion Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IKEPolicyVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IKEPolicy_version';
    ...
    public const LABEL_IKEV1 = 'IKEv1';
    public const LABEL_IKEV2 = 'IKEv2';
    ...
    */
     ...
     * Sets value
     *
     * @param int|null $value * `1` - IKEv1 * `2` - IKEv2
     *
     * @return self
     */
