...
/**
 * PrefixStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PrefixStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Prefix_status';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `container` - Container * `active` - Active * `reserved` - Reserved * `deprecated` - Deprecated
     *
     * @return self
     */
