...
/**
 * PatchedWritableWirelessLinkRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableWirelessLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableWirelessLinkRequest';
    ...
    */
     ...
     * Gets interface_a
     *
     * @return \OpenAPI\Client\Model\BriefInterfaceRequest|null
     */
     ...
     * Sets interface_a
     *
     * @param \OpenAPI\Client\Model\BriefInterfaceRequest|null $interface_a interface_a
     *
     * @return self
     */
     ...
     * Sets interface_b
     *
     * @param \OpenAPI\Client\Model\BriefInterfaceRequest|null $interface_b interface_b
     *
     * @return self
     */
    ...
    public function setSsid($ssid)
    {
        ...
        if ((mb_strlen($ssid) > 32)) {
            throw new \InvalidArgumentException('invalid length for $ssid when calling PatchedWritableWirelessLinkRequest., must be smaller than or equal to 32.');
        }
    ...
    public function setAuthPsk($auth_psk)
    {
        ...
        if ((mb_strlen($auth_psk) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_psk when calling PatchedWritableWirelessLinkRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setDistance($distance)
    {
        ...
        if (!is_null($distance) && ($distance >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling PatchedWritableWirelessLinkRequest., must be smaller than 1000000.');
        }
        if (!is_null($distance) && ($distance <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $distance when calling PatchedWritableWirelessLinkRequest., must be bigger than -1000000.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableWirelessLinkRequest., must be smaller than or equal to 200.');
        }
