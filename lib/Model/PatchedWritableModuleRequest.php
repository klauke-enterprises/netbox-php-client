...
/**
 * PatchedWritableModuleRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableModuleRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableModuleRequest';
    ...
    */
     ...
     * Sets module_bay
     *
     * @param int|null $module_bay module_bay
     *
     * @return self
     */
    ...
    public function setSerial($serial)
    {
        ...
        if ((mb_strlen($serial) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial when calling PatchedWritableModuleRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setAssetTag($asset_tag)
    {
        ...
        if (!is_null($asset_tag) && (mb_strlen($asset_tag) > 50)) {
            throw new \InvalidArgumentException('invalid length for $asset_tag when calling PatchedWritableModuleRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableModuleRequest., must be smaller than or equal to 200.');
        }
