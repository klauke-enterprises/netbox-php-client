...
/**
 * BriefModuleType Class Doc Comment
 *
 * @category Class
 ...
 */
class BriefModuleType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BriefModuleType';
    ...
    */
    ...
    public function setModel($model)
    {
        ...
        if ((mb_strlen($model) > 100)) {
            throw new \InvalidArgumentException('invalid length for $model when calling BriefModuleType., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BriefModuleType., must be smaller than or equal to 200.');
        }
