...
/**
 * JournalEntryKind Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class JournalEntryKind implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JournalEntry_kind';
    ...
    public const VALUE_INFO = 'info';
    public const VALUE_SUCCESS = 'success';
    public const VALUE_WARNING = 'warning';
    public const VALUE_DANGER = 'danger';
    public const LABEL_INFO = 'Info';
    public const LABEL_SUCCESS = 'Success';
    public const LABEL_WARNING = 'Warning';
    public const LABEL_DANGER = 'Danger';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `info` - Info * `success` - Success * `warning` - Warning * `danger` - Danger
     *
     * @return self
     */
