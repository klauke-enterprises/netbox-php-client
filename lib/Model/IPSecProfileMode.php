...
/**
 * IPSecProfileMode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IPSecProfileMode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPSecProfile_mode';
    ...
    public const VALUE_ESP = 'esp';
    public const VALUE_AH = 'ah';
    public const LABEL_ESP = 'ESP';
    public const LABEL_AH = 'AH';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `esp` - ESP * `ah` - AH
     *
     * @return self
     */
