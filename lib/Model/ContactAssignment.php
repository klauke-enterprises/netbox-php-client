...
/**
 * ContactAssignment Class Doc Comment
 *
 * @category Class
 ...
 */
class ContactAssignment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContactAssignment';
    ...
    protected static $openAPITypes = [
        ...
        'contact' => '\OpenAPI\Client\Model\BriefContact',
        'role' => '\OpenAPI\Client\Model\BriefContactRole',
        'priority' => '\OpenAPI\Client\Model\BriefCircuitGroupAssignmentSerializerPriority',
    ...
    */
    ...
    public function setObjectId($object_id)
    {
        ...
        if (($object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling ContactAssignment., must be smaller than or equal to 9223372036854775807.');
        }
        if (($object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling ContactAssignment., must be bigger than or equal to 0.');
        }
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\BriefContact
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\BriefContact $contact contact
     *
     * @return self
     */
     ...
     * Gets role
     *
     * @return \OpenAPI\Client\Model\BriefContactRole|null
     */
     ...
     * Sets role
     *
     * @param \OpenAPI\Client\Model\BriefContactRole|null $role role
     *
     * @return self
     */
     ...
     * Gets priority
     *
     * @return \OpenAPI\Client\Model\BriefCircuitGroupAssignmentSerializerPriority|null
     */
     ...
     * Sets priority
     *
     * @param \OpenAPI\Client\Model\BriefCircuitGroupAssignmentSerializerPriority|null $priority priority
     *
     * @return self
     */
