...
/**
 * WirelessLANAuthCipher Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WirelessLANAuthCipher implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WirelessLAN_auth_cipher';
    ...
    public const VALUE_TKIP = 'tkip';
    public const VALUE_AES = 'aes';
    public const VALUE_EMPTY = '';
    public const LABEL_AUTO = 'Auto';
    public const LABEL_TKIP = 'TKIP';
    public const LABEL_AES = 'AES';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `auto` - Auto * `tkip` - TKIP * `aes` - AES
     *
     * @return self
     */
