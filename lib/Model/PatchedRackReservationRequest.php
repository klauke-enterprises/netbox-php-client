...
/**
 * PatchedRackReservationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedRackReservationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedRackReservationRequest';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedRackReservationRequest., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedRackReservationRequest., must be bigger than or equal to 1.');
        }
