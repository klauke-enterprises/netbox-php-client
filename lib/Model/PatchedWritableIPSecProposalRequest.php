...
/**
 * PatchedWritableIPSecProposalRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableIPSecProposalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableIPSecProposalRequest';
    ...
    public const ENCRYPTION_ALGORITHM_EMPTY = '';
    ...
    public function getEncryptionAlgorithmAllowableValues()
    {
        return [
            ...
            self::ENCRYPTION_ALGORITHM_EMPTY,
        ];
    }
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableIPSecProposalRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableIPSecProposalRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableIPSecProposalRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setSaLifetimeSeconds($sa_lifetime_seconds)
    {
        ...
        if (!is_null($sa_lifetime_seconds) && ($sa_lifetime_seconds > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime_seconds when calling PatchedWritableIPSecProposalRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($sa_lifetime_seconds) && ($sa_lifetime_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime_seconds when calling PatchedWritableIPSecProposalRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setSaLifetimeData($sa_lifetime_data)
    {
        ...
        if (!is_null($sa_lifetime_data) && ($sa_lifetime_data > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime_data when calling PatchedWritableIPSecProposalRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($sa_lifetime_data) && ($sa_lifetime_data < 0)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime_data when calling PatchedWritableIPSecProposalRequest., must be bigger than or equal to 0.');
        }
