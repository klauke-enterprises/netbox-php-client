...
class Script implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'vars' => 'mixed',
        'result' => '\OpenAPI\Client\Model\BriefJob',
        'display' => 'string',
        'is_executable' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_executable', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vars'] === null) {
            $invalidProperties[] = "'vars' can't be null";
        }
        ...
        if ($this->container['is_executable'] === null) {
            $invalidProperties[] = "'is_executable' can't be null";
        }
    ...
    {
        if (is_null($vars)) {
            array_push($this->openAPINullablesSetToNull, 'vars');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('vars', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\BriefJob
     */
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\BriefJob $result result
     *
     * @return self
     */
     ...
     * Sets is_executable
     *
     * @param bool $is_executable is_executable
     *
     * @return self
     */
    public function setIsExecutable($is_executable)
    {
        if (is_null($is_executable)) {
            throw new \InvalidArgumentException('non-nullable is_executable cannot be null');
        }
