...
/**
 * WritableIPRangeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableIPRangeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableIPRangeRequest';
    ...
    */
    ...
    public function setStartAddress($start_address)
    {
        ...
        if ((mb_strlen($start_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $start_address when calling WritableIPRangeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setEndAddress($end_address)
    {
        ...
        if ((mb_strlen($end_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $end_address when calling WritableIPRangeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableIPRangeRequest., must be smaller than or equal to 200.');
        }
