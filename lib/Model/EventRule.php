 ...
 */
class EventRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventRule';
    ...
    protected static $openAPITypes = [
        ...
        'enabled' => 'bool',
        'conditions' => 'mixed',
        'action_type' => '\OpenAPI\Client\Model\EventRuleActionType',
        'action_object_type' => 'string',
        'action_object_id' => 'int',
        'action_object' => 'array<string,mixed>',
        'description' => 'string',
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling EventRule., must be smaller than or equal to 150.');
        }
     ...
     * Gets action_type
     *
     * @return \OpenAPI\Client\Model\EventRuleActionType
     */
     ...
     * Sets action_type
     *
     * @param \OpenAPI\Client\Model\EventRuleActionType $action_type action_type
     *
     * @return self
     */
    ...
    public function setActionObjectId($action_object_id)
    {
        ...
        if (!is_null($action_object_id) && ($action_object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $action_object_id when calling EventRule., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($action_object_id) && ($action_object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $action_object_id when calling EventRule., must be bigger than or equal to 0.');
        }
     ...
     * Sets action_object
     *
     * @param array<string,mixed> $action_object action_object
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling EventRule., must be smaller than or equal to 200.');
        }
