...
/**
 * ModuleTypeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ModuleTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModuleTypeRequest';
    ...
    */
    ...
    public function setModel($model)
    {
        ...
        if ((mb_strlen($model) > 100)) {
            throw new \InvalidArgumentException('invalid length for $model when calling ModuleTypeRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($model) < 1)) {
            throw new \InvalidArgumentException('invalid length for $model when calling ModuleTypeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartNumber($part_number)
    {
        ...
        if ((mb_strlen($part_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $part_number when calling ModuleTypeRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets airflow
     *
     * @param string|null $airflow * `front-to-rear` - Front to rear * `rear-to-front` - Rear to front * `left-to-right` - Left to right * `right-to-left` - Right to left * `side-to-rear` - Side to rear * `passive` - Passive
     *
     * @return self
     */
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling ModuleTypeRequest., must be smaller than 1000000.');
        }
        if (!is_null($weight) && ($weight <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling ModuleTypeRequest., must be bigger than -1000000.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ModuleTypeRequest., must be smaller than or equal to 200.');
        }
