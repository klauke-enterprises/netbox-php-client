...
/**
 * NestedWirelessLinkRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedWirelessLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedWirelessLinkRequest';
    ...
    */
    ...
    public function setSsid($ssid)
    {
        ...
        if ((mb_strlen($ssid) > 32)) {
            throw new \InvalidArgumentException('invalid length for $ssid when calling NestedWirelessLinkRequest., must be smaller than or equal to 32.');
        }
