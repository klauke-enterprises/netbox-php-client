...
/**
 * IKEPolicyMode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IKEPolicyMode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IKEPolicy_mode';
    ...
    public const VALUE_AGGRESSIVE = 'aggressive';
    public const VALUE_MAIN = 'main';
    public const LABEL_AGGRESSIVE = 'Aggressive';
    public const LABEL_MAIN = 'Main';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `aggressive` - Aggressive * `main` - Main
     *
     * @return self
     */
