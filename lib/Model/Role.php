    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Role., must be smaller than or equal to 100.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling Role., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling Role., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 32767)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling Role., must be smaller than or equal to 32767.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling Role., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Role., must be smaller than or equal to 200.');
        }
