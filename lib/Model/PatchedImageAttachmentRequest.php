...
class PatchedImageAttachmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['image_height']) && ($this->container['image_height'] > 32767)) {
            $invalidProperties[] = "invalid value for 'image_height', must be smaller than or equal to 32767.";
        }

        if (!is_null($this->container['image_height']) && ($this->container['image_height'] < 0)) {
            $invalidProperties[] = "invalid value for 'image_height', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['image_width']) && ($this->container['image_width'] > 32767)) {
            $invalidProperties[] = "invalid value for 'image_width', must be smaller than or equal to 32767.";
        }

        if (!is_null($this->container['image_width']) && ($this->container['image_width'] < 0)) {
    ...
    public function setImageHeight($image_height)
    {
        ...
        if (($image_height > 32767)) {
            throw new \InvalidArgumentException('invalid value for $image_height when calling PatchedImageAttachmentRequest., must be smaller than or equal to 32767.');
        }
        if (($image_height < 0)) {
            throw new \InvalidArgumentException('invalid value for $image_height when calling PatchedImageAttachmentRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setImageWidth($image_width)
    {
        ...
        if (($image_width > 32767)) {
            throw new \InvalidArgumentException('invalid value for $image_width when calling PatchedImageAttachmentRequest., must be smaller than or equal to 32767.');
        }
        if (($image_width < 0)) {
            throw new \InvalidArgumentException('invalid value for $image_width when calling PatchedImageAttachmentRequest., must be bigger than or equal to 0.');
        }
