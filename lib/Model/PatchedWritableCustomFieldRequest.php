...
/**
 * PatchedWritableCustomFieldRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableCustomFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableCustomFieldRequest';
    ...
    protected static $openAPITypes = [
        ...
        'choice_set' => '\OpenAPI\Client\Model\CustomFieldChoiceSetRequest',
        'comments' => 'string'
    ];
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The type of data this custom field holds  * `text` - Text * `longtext` - Text (long) * `integer` - Integer * `decimal` - Decimal * `boolean` - Boolean (true/false) * `date` - Date * `datetime` - Date & time * `url` - URL * `json` - JSON * `select` - Selection * `multiselect` - Multiple selection * `object` - Object * `multiobject` - Multiple objects
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Internal field name
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableCustomFieldRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[a-z0-9_]+$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling PatchedWritableCustomFieldRequest., must conform to the pattern /^[a-z0-9_]+$/.");
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 50)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setGroupName($group_name)
    {
        ...
        if ((mb_strlen($group_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $group_name when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 200.');
        }
     ...
     * Sets required
     *
     * @param bool|null $required If true, this field is required when creating new objects or editing an existing object.
     *
     * @return self
     */
    ...
    public function setSearchWeight($search_weight)
    {
        ...
        if (($search_weight > 32767)) {
            throw new \InvalidArgumentException('invalid value for $search_weight when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 32767.');
        }
        if (($search_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $search_weight when calling PatchedWritableCustomFieldRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets filter_logic
     *
     * @param string|null $filter_logic Loose matches any instance of a given string; exact matches the entire field.  * `disabled` - Disabled * `loose` - Loose * `exact` - Exact
     *
     * @return self
     */
     ...
     * Sets ui_visible
     *
     * @param string|null $ui_visible Specifies whether the custom field is displayed in the UI  * `always` - Always * `if-set` - If set * `hidden` - Hidden
     *
     * @return self
     */
     ...
     * Sets ui_editable
     *
     * @param string|null $ui_editable Specifies whether the custom field value can be edited in the UI  * `yes` - Yes * `no` - No * `hidden` - Hidden
     *
     * @return self
     */
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 32767)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 32767.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedWritableCustomFieldRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setValidationMinimum($validation_minimum)
    {
        ...
        if (!is_null($validation_minimum) && ($validation_minimum > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $validation_minimum when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($validation_minimum) && ($validation_minimum < -9223372036854775808)) {
            throw new \InvalidArgumentException('invalid value for $validation_minimum when calling PatchedWritableCustomFieldRequest., must be bigger than or equal to -9223372036854775808.');
        }
    ...
    public function setValidationMaximum($validation_maximum)
    {
        ...
        if (!is_null($validation_maximum) && ($validation_maximum > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $validation_maximum when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($validation_maximum) && ($validation_maximum < -9223372036854775808)) {
            throw new \InvalidArgumentException('invalid value for $validation_maximum when calling PatchedWritableCustomFieldRequest., must be bigger than or equal to -9223372036854775808.');
        }
    ...
    public function setValidationRegex($validation_regex)
    {
        ...
        if ((mb_strlen($validation_regex) > 500)) {
            throw new \InvalidArgumentException('invalid length for $validation_regex when calling PatchedWritableCustomFieldRequest., must be smaller than or equal to 500.');
        }
     ...
     * Gets choice_set
     *
     * @return \OpenAPI\Client\Model\CustomFieldChoiceSetRequest|null
     */
     ...
     * Sets choice_set
     *
     * @param \OpenAPI\Client\Model\CustomFieldChoiceSetRequest|null $choice_set choice_set
     *
     * @return self
     */
