...
/**
 * CircuitTerminationRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CircuitTerminationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CircuitTerminationRequest';
    ...
    */
     ...
     * Gets circuit
     *
     * @return \OpenAPI\Client\Model\CircuitRequest
     */
     ...
     * Sets circuit
     *
     * @param \OpenAPI\Client\Model\CircuitRequest $circuit circuit
     *
     * @return self
     */
    ...
    public function setPortSpeed($port_speed)
    {
        ...
        if (!is_null($port_speed) && ($port_speed > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $port_speed when calling CircuitTerminationRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($port_speed) && ($port_speed < 0)) {
            throw new \InvalidArgumentException('invalid value for $port_speed when calling CircuitTerminationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setUpstreamSpeed($upstream_speed)
    {
        ...
        if (!is_null($upstream_speed) && ($upstream_speed > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $upstream_speed when calling CircuitTerminationRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($upstream_speed) && ($upstream_speed < 0)) {
            throw new \InvalidArgumentException('invalid value for $upstream_speed when calling CircuitTerminationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setXconnectId($xconnect_id)
    {
        ...
        if ((mb_strlen($xconnect_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $xconnect_id when calling CircuitTerminationRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setPpInfo($pp_info)
    {
        ...
        if ((mb_strlen($pp_info) > 100)) {
            throw new \InvalidArgumentException('invalid length for $pp_info when calling CircuitTerminationRequest., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CircuitTerminationRequest., must be smaller than or equal to 200.');
        }
