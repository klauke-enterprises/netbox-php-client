...
/**
 * PatchedWritableContactAssignmentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableContactAssignmentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableContactAssignmentRequest';
    ...
    */
    ...
    public function setObjectId($object_id)
    {
        ...
        if (($object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling PatchedWritableContactAssignmentRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (($object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling PatchedWritableContactAssignmentRequest., must be bigger than or equal to 0.');
        }
     ...
     * Gets contact
     *
     * @return \OpenAPI\Client\Model\BriefContactRequest|null
     */
     ...
     * Sets contact
     *
     * @param \OpenAPI\Client\Model\BriefContactRequest|null $contact contact
     *
     * @return self
     */
