...
/**
 * DeviceWithConfigContextRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DeviceWithConfigContextRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceWithConfigContextRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling DeviceWithConfigContextRequest., must be smaller than or equal to 64.');
        }
     ...
     * Gets role
     *
     * @return \OpenAPI\Client\Model\BriefDeviceRoleRequest
     */
     ...
     * Sets role
     *
     * @param \OpenAPI\Client\Model\BriefDeviceRoleRequest $role role
     *
     * @return self
     */
    ...
    public function setSerial($serial)
    {
        ...
        if ((mb_strlen($serial) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial when calling DeviceWithConfigContextRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setAssetTag($asset_tag)
    {
        ...
        if (!is_null($asset_tag) && (mb_strlen($asset_tag) > 50)) {
            throw new \InvalidArgumentException('invalid length for $asset_tag when calling DeviceWithConfigContextRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setPosition($position)
    {
        ...
        if (!is_null($position) && ($position >= 1000)) {
            throw new \InvalidArgumentException('invalid value for $position when calling DeviceWithConfigContextRequest., must be smaller than 1000.');
        }
        if (!is_null($position) && ($position < 0.5)) {
            throw new \InvalidArgumentException('invalid value for $position when calling DeviceWithConfigContextRequest., must be bigger than or equal to 0.5.');
        }
    ...
    public function setLatitude($latitude)
    {
        ...
        if (!is_null($latitude) && ($latitude >= 100)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling DeviceWithConfigContextRequest., must be smaller than 100.');
        }
        if (!is_null($latitude) && ($latitude <= -100)) {
            throw new \InvalidArgumentException('invalid value for $latitude when calling DeviceWithConfigContextRequest., must be bigger than -100.');
        }
    ...
    public function setLongitude($longitude)
    {
        ...
        if (!is_null($longitude) && ($longitude >= 1000)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling DeviceWithConfigContextRequest., must be smaller than 1000.');
        }
        if (!is_null($longitude) && ($longitude <= -1000)) {
            throw new \InvalidArgumentException('invalid value for $longitude when calling DeviceWithConfigContextRequest., must be bigger than -1000.');
        }
    ...
    public function setVcPosition($vc_position)
    {
        ...
        if (!is_null($vc_position) && ($vc_position > 255)) {
            throw new \InvalidArgumentException('invalid value for $vc_position when calling DeviceWithConfigContextRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($vc_position) && ($vc_position < 0)) {
            throw new \InvalidArgumentException('invalid value for $vc_position when calling DeviceWithConfigContextRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setVcPriority($vc_priority)
    {
        ...
        if (!is_null($vc_priority) && ($vc_priority > 255)) {
            throw new \InvalidArgumentException('invalid value for $vc_priority when calling DeviceWithConfigContextRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($vc_priority) && ($vc_priority < 0)) {
            throw new \InvalidArgumentException('invalid value for $vc_priority when calling DeviceWithConfigContextRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DeviceWithConfigContextRequest., must be smaller than or equal to 200.');
        }
