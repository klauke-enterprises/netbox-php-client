...
/**
 * ProviderNetwork Class Doc Comment
 *
 * @category Class
 ...
 */
class ProviderNetwork implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProviderNetwork';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ProviderNetwork., must be smaller than or equal to 100.');
        }
    ...
    public function setServiceId($service_id)
    {
        ...
        if ((mb_strlen($service_id) > 100)) {
            throw new \InvalidArgumentException('invalid length for $service_id when calling ProviderNetwork., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ProviderNetwork., must be smaller than or equal to 200.');
        }
