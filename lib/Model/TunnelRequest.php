...
/**
 * TunnelRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TunnelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TunnelRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TunnelRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling TunnelRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param string $status * `planned` - Planned * `active` - Active * `disabled` - Disabled
     *
     * @return self
     */
    ...
    public function setTunnelId($tunnel_id)
    {
        ...
        if (!is_null($tunnel_id) && ($tunnel_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $tunnel_id when calling TunnelRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($tunnel_id) && ($tunnel_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $tunnel_id when calling TunnelRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TunnelRequest., must be smaller than or equal to 200.');
        }
