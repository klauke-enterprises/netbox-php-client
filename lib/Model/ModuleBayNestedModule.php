...
/**
 * ModuleBayNestedModule Class Doc Comment
 *
 * @category Class
 ...
 */
class ModuleBayNestedModule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModuleBayNestedModule';
    ...
    */
    ...
    public function setSerial($serial)
    {
        ...
        if ((mb_strlen($serial) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial when calling ModuleBayNestedModule., must be smaller than or equal to 50.');
        }
