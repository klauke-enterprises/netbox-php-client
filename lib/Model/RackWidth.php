 ...
 */
class RackWidth implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Rack_width';
    ...
    public const LABEL__10_INCHES = '10 inches';
    public const LABEL__19_INCHES = '19 inches';
    public const LABEL__21_INCHES = '21 inches';
    public const LABEL__23_INCHES = '23 inches';
    ...
    {
        return [
            self::LABEL__10_INCHES,
            self::LABEL__19_INCHES,
            self::LABEL__21_INCHES,
            self::LABEL__23_INCHES,
        ];
    }
    ...
    */
     ...
     * Sets value
     *
     * @param int|null $value * `10` - 10 inches * `19` - 19 inches * `21` - 21 inches * `23` - 23 inches
     *
     * @return self
     */
