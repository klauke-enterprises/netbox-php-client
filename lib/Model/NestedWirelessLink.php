...
/**
 * NestedWirelessLink Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedWirelessLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedWirelessLink';
    ...
    */
    ...
    public function setSsid($ssid)
    {
        ...
        if ((mb_strlen($ssid) > 32)) {
            throw new \InvalidArgumentException('invalid length for $ssid when calling NestedWirelessLink., must be smaller than or equal to 32.');
        }
