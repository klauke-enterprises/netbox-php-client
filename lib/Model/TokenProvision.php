...
/**
 * TokenProvision Class Doc Comment
 *
 * @category Class
 ...
 */
class TokenProvision implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenProvision';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TokenProvision., must be smaller than or equal to 200.');
        }
