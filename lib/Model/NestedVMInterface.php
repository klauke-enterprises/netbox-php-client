...
/**
 * NestedVMInterface Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedVMInterface implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedVMInterface';
    ...
    protected static $openAPITypes = [
        ...
        'url' => 'string',
        'display' => 'string',
        'virtual_machine' => '\OpenAPI\Client\Model\NestedVirtualMachine',
        'name' => 'string'
    ];
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\NestedVirtualMachine
     */
     ...
     *
     * @param \OpenAPI\Client\Model\NestedVirtualMachine $virtual_machine virtual_machine
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NestedVMInterface., must be smaller than or equal to 64.');
        }
