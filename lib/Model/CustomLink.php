 ...
 */
class CustomLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomLink';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomLink., must be smaller than or equal to 100.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight > 32767)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CustomLink., must be smaller than or equal to 32767.');
        }
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling CustomLink., must be bigger than or equal to 0.');
        }
    ...
    public function setGroupName($group_name)
    {
        ...
        if ((mb_strlen($group_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $group_name when calling CustomLink., must be smaller than or equal to 50.');
        }
