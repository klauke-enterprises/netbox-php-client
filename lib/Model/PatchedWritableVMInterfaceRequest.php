...
/**
 * PatchedWritableVMInterfaceRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableVMInterfaceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableVMInterfaceRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableVMInterfaceRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableVMInterfaceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMtu($mtu)
    {
        ...
        if (!is_null($mtu) && ($mtu > 65536)) {
            throw new \InvalidArgumentException('invalid value for $mtu when calling PatchedWritableVMInterfaceRequest., must be smaller than or equal to 65536.');
        }
        if (!is_null($mtu) && ($mtu < 1)) {
            throw new \InvalidArgumentException('invalid value for $mtu when calling PatchedWritableVMInterfaceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMacAddress($mac_address)
    {
        ...
        if (!is_null($mac_address) && (mb_strlen($mac_address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $mac_address when calling PatchedWritableVMInterfaceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableVMInterfaceRequest., must be smaller than or equal to 200.');
        }
