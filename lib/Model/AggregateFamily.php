...
/**
 * AggregateFamily Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AggregateFamily implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Aggregate_family';
    ...
    public const LABEL_IPV4 = 'IPv4';
    public const LABEL_IPV6 = 'IPv6';
    ...
    */
     ...
     * Sets value
     *
     * @param int|null $value * `4` - IPv4 * `6` - IPv6
     *
     * @return self
     */
