...
/**
 * PaginatedWirelessLinkList Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PaginatedWirelessLinkList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaginatedWirelessLinkList';
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\WirelessLink[]'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\WirelessLink[] $results results
     *
     * @return self
     */
