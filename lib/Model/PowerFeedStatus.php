...
/**
 * PowerFeedStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PowerFeedStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerFeed_status';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `offline` - Offline * `active` - Active * `planned` - Planned * `failed` - Failed
     *
     * @return self
     */
