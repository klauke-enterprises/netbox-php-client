...
/**
 * ImageAttachment Class Doc Comment
 *
 * @category Class
 ...
 */
class ImageAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageAttachment';
    ...
    */
    ...
    public function setObjectId($object_id)
    {
        ...
        if (($object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling ImageAttachment., must be smaller than or equal to 9223372036854775807.');
        }
        if (($object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling ImageAttachment., must be bigger than or equal to 0.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ImageAttachment., must be smaller than or equal to 50.');
        }
    ...
    public function setImageHeight($image_height)
    {
        ...
        if (($image_height > 32767)) {
            throw new \InvalidArgumentException('invalid value for $image_height when calling ImageAttachment., must be smaller than or equal to 32767.');
        }
        if (($image_height < 0)) {
            throw new \InvalidArgumentException('invalid value for $image_height when calling ImageAttachment., must be bigger than or equal to 0.');
        }
    ...
    public function setImageWidth($image_width)
    {
        ...
        if (($image_width > 32767)) {
            throw new \InvalidArgumentException('invalid value for $image_width when calling ImageAttachment., must be smaller than or equal to 32767.');
        }
        if (($image_width < 0)) {
            throw new \InvalidArgumentException('invalid value for $image_width when calling ImageAttachment., must be bigger than or equal to 0.');
        }
