...
/**
 * PatchedWritableRackRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableRackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableRackRequest';
    ...
    protected static $openAPITypes = [
        ...
        'status' => 'string',
        'role' => '\OpenAPI\Client\Model\RackRoleRequest',
        'serial' => 'string',
        'asset_tag' => 'string',
        'type' => 'string',
        'width' => 'int',
    ...
    public const TYPE__2_POST_FRAME = '2-post-frame';
    public const TYPE__4_POST_FRAME = '4-post-frame';
    public const TYPE__4_POST_CABINET = '4-post-cabinet';
    public const TYPE_WALL_FRAME = 'wall-frame';
    public const TYPE_WALL_FRAME_VERTICAL = 'wall-frame-vertical';
    public const TYPE_WALL_CABINET = 'wall-cabinet';
    public const TYPE_WALL_CABINET_VERTICAL = 'wall-cabinet-vertical';
    ...
    {
        return [
            self::TYPE__2_POST_FRAME,
            self::TYPE__4_POST_FRAME,
            self::TYPE__4_POST_CABINET,
            self::TYPE_WALL_FRAME,
            self::TYPE_WALL_FRAME_VERTICAL,
            self::TYPE_WALL_CABINET,
            self::TYPE_WALL_CABINET_VERTICAL,
            self::TYPE_EMPTY,
        ];
    }
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableRackRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableRackRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFacilityId($facility_id)
    {
        ...
        if (!is_null($facility_id) && (mb_strlen($facility_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $facility_id when calling PatchedWritableRackRequest., must be smaller than or equal to 50.');
        }
     ...
     * Gets role
     *
     * @return \OpenAPI\Client\Model\RackRoleRequest|null
     */
     ...
     * Sets role
     *
     * @param \OpenAPI\Client\Model\RackRoleRequest|null $role role
     *
     * @return self
     */
    ...
    public function setSerial($serial)
    {
        ...
        if ((mb_strlen($serial) > 50)) {
            throw new \InvalidArgumentException('invalid length for $serial when calling PatchedWritableRackRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setAssetTag($asset_tag)
    {
        ...
        if (!is_null($asset_tag) && (mb_strlen($asset_tag) > 50)) {
            throw new \InvalidArgumentException('invalid length for $asset_tag when calling PatchedWritableRackRequest., must be smaller than or equal to 50.');
        }
     ...
     * Sets type
     *
     * @param string|null $type * `2-post-frame` - 2-post frame * `4-post-frame` - 4-post frame * `4-post-cabinet` - 4-post cabinet * `wall-frame` - Wall-mounted frame * `wall-frame-vertical` - Wall-mounted frame (vertical) * `wall-cabinet` - Wall-mounted cabinet * `wall-cabinet-vertical` - Wall-mounted cabinet (vertical)
     *
     * @return self
     */
    ...
    public function setWidth($width)
    {
        ...
        if (($width > 32767)) {
            throw new \InvalidArgumentException('invalid value for $width when calling PatchedWritableRackRequest., must be smaller than or equal to 32767.');
        }
        if (($width < 0)) {
            throw new \InvalidArgumentException('invalid value for $width when calling PatchedWritableRackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setUHeight($u_height)
    {
        ...
        if (($u_height > 100)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling PatchedWritableRackRequest., must be smaller than or equal to 100.');
        }
        if (($u_height < 1)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling PatchedWritableRackRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setStartingUnit($starting_unit)
    {
        ...
        if (($starting_unit > 32767)) {
            throw new \InvalidArgumentException('invalid value for $starting_unit when calling PatchedWritableRackRequest., must be smaller than or equal to 32767.');
        }
        if (($starting_unit < 1)) {
            throw new \InvalidArgumentException('invalid value for $starting_unit when calling PatchedWritableRackRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedWritableRackRequest., must be smaller than 1000000.');
        }
        if (!is_null($weight) && ($weight <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling PatchedWritableRackRequest., must be bigger than -1000000.');
        }
    ...
    public function setMaxWeight($max_weight)
    {
        ...
        if (!is_null($max_weight) && ($max_weight > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $max_weight when calling PatchedWritableRackRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($max_weight) && ($max_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_weight when calling PatchedWritableRackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setOuterWidth($outer_width)
    {
        ...
        if (!is_null($outer_width) && ($outer_width > 32767)) {
            throw new \InvalidArgumentException('invalid value for $outer_width when calling PatchedWritableRackRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($outer_width) && ($outer_width < 0)) {
            throw new \InvalidArgumentException('invalid value for $outer_width when calling PatchedWritableRackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setOuterDepth($outer_depth)
    {
        ...
        if (!is_null($outer_depth) && ($outer_depth > 32767)) {
            throw new \InvalidArgumentException('invalid value for $outer_depth when calling PatchedWritableRackRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($outer_depth) && ($outer_depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $outer_depth when calling PatchedWritableRackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMountingDepth($mounting_depth)
    {
        ...
        if (!is_null($mounting_depth) && ($mounting_depth > 32767)) {
            throw new \InvalidArgumentException('invalid value for $mounting_depth when calling PatchedWritableRackRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($mounting_depth) && ($mounting_depth < 0)) {
            throw new \InvalidArgumentException('invalid value for $mounting_depth when calling PatchedWritableRackRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableRackRequest., must be smaller than or equal to 200.');
        }
