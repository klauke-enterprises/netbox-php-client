...
/**
 * CircuitRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CircuitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CircuitRequest';
    ...
    */
    ...
    public function setCid($cid)
    {
        ...
        if ((mb_strlen($cid) > 100)) {
            throw new \InvalidArgumentException('invalid length for $cid when calling CircuitRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($cid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $cid when calling CircuitRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCommitRate($commit_rate)
    {
        ...
        if (!is_null($commit_rate) && ($commit_rate > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $commit_rate when calling CircuitRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($commit_rate) && ($commit_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $commit_rate when calling CircuitRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CircuitRequest., must be smaller than or equal to 200.');
        }
