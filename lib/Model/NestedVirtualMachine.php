...
/**
 * NestedVirtualMachine Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedVirtualMachine implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedVirtualMachine';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling NestedVirtualMachine., must be smaller than or equal to 64.');
        }
