...
/**
 * TunnelTerminationRole Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TunnelTerminationRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TunnelTermination_role';
    ...
    public const VALUE_PEER = 'peer';
    public const VALUE_HUB = 'hub';
    public const VALUE_SPOKE = 'spoke';
    public const LABEL_PEER = 'Peer';
    public const LABEL_HUB = 'Hub';
    public const LABEL_SPOKE = 'Spoke';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `peer` - Peer * `hub` - Hub * `spoke` - Spoke
     *
     * @return self
     */
