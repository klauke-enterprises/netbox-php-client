...
/**
 * PatchedSubscriptionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedSubscriptionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedSubscriptionRequest';
    ...
    */
    ...
    public function setObjectId($object_id)
    {
        ...
        if (($object_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling PatchedSubscriptionRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (($object_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $object_id when calling PatchedSubscriptionRequest., must be bigger than or equal to 0.');
        }
