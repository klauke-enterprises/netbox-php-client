...
/**
 * WritableConsolePortTemplateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableConsolePortTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableConsolePortTemplateRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableConsolePortTemplateRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableConsolePortTemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling WritableConsolePortTemplateRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableConsolePortTemplateRequest., must be smaller than or equal to 200.');
        }
