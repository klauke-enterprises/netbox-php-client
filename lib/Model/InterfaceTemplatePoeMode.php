...
/**
 * InterfaceTemplatePoeMode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InterfaceTemplatePoeMode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InterfaceTemplate_poe_mode';
    ...
    public const VALUE_PD = 'pd';
    public const VALUE_PSE = 'pse';
    public const VALUE_EMPTY = '';
    public const VALUE_NULL = 'null';
    public const LABEL_PD = 'PD';
    public const LABEL_PSE = 'PSE';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `pd` - PD * `pse` - PSE
     *
     * @return self
     */
