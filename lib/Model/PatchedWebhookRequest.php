...
/**
 * PatchedWebhookRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWebhookRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWebhookRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['payload_url']) && (mb_strlen($this->container['payload_url']) > 500)) {
            $invalidProperties[] = "invalid value for 'payload_url', the character length must be smaller than or equal to 500.";
        }

        if (!is_null($this->container['payload_url']) && (mb_strlen($this->container['payload_url']) < 1)) {
            $invalidProperties[] = "invalid value for 'payload_url', the character length must be bigger than or equal to 1.";
        }
        ...
        if (!is_null($this->container['http_content_type']) && (mb_strlen($this->container['http_content_type']) < 1)) {
            $invalidProperties[] = "invalid value for 'http_content_type', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 150)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWebhookRequest., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWebhookRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWebhookRequest., must be smaller than or equal to 200.');
        }
     ...
     * Sets payload_url
     *
     * @param string|null $payload_url This URL will be called using the HTTP method defined when the webhook is called. Jinja2 template processing is supported with the same context as the request body.
     *
     * @return self
     */
    public function setPayloadUrl($payload_url)
    {
        ...
        if ((mb_strlen($payload_url) > 500)) {
            throw new \InvalidArgumentException('invalid length for $payload_url when calling PatchedWebhookRequest., must be smaller than or equal to 500.');
        }
        if ((mb_strlen($payload_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payload_url when calling PatchedWebhookRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setHttpContentType($http_content_type)
    {
        ...
        if ((mb_strlen($http_content_type) > 100)) {
            throw new \InvalidArgumentException('invalid length for $http_content_type when calling PatchedWebhookRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($http_content_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $http_content_type when calling PatchedWebhookRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSecret($secret)
    {
        ...
        if ((mb_strlen($secret) > 255)) {
            throw new \InvalidArgumentException('invalid length for $secret when calling PatchedWebhookRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setCaFilePath($ca_file_path)
    {
        ...
        if (!is_null($ca_file_path) && (mb_strlen($ca_file_path) > 4096)) {
            throw new \InvalidArgumentException('invalid length for $ca_file_path when calling PatchedWebhookRequest., must be smaller than or equal to 4096.');
        }
