...
/**
 * BriefCircuit Class Doc Comment
 *
 * @category Class
 ...
 */
class BriefCircuit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BriefCircuit';
    ...
    */
    ...
    public function setCid($cid)
    {
        ...
        if ((mb_strlen($cid) > 100)) {
            throw new \InvalidArgumentException('invalid length for $cid when calling BriefCircuit., must be smaller than or equal to 100.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling BriefCircuit., must be smaller than or equal to 200.');
        }
