...
/**
 * IPSecProposalRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class IPSecProposalRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPSecProposalRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling IPSecProposalRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling IPSecProposalRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling IPSecProposalRequest., must be smaller than or equal to 200.');
        }
     ...
     *
     * @param string $authentication_algorithm * `hmac-sha1` - SHA-1 HMAC * `hmac-sha256` - SHA-256 HMAC * `hmac-sha384` - SHA-384 HMAC * `hmac-sha512` - SHA-512 HMAC * `hmac-md5` - MD5 HMAC
     *
     * @return self
     */
    ...
    public function setSaLifetimeSeconds($sa_lifetime_seconds)
    {
        ...
        if (!is_null($sa_lifetime_seconds) && ($sa_lifetime_seconds > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime_seconds when calling IPSecProposalRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($sa_lifetime_seconds) && ($sa_lifetime_seconds < 0)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime_seconds when calling IPSecProposalRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setSaLifetimeData($sa_lifetime_data)
    {
        ...
        if (!is_null($sa_lifetime_data) && ($sa_lifetime_data > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime_data when calling IPSecProposalRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($sa_lifetime_data) && ($sa_lifetime_data < 0)) {
            throw new \InvalidArgumentException('invalid value for $sa_lifetime_data when calling IPSecProposalRequest., must be bigger than or equal to 0.');
        }
