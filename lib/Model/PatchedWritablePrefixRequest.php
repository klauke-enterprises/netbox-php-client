...
/**
 * PatchedWritablePrefixRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritablePrefixRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritablePrefixRequest';
    ...
    protected static $openAPITypes = [
        ...
        'vlan' => '\OpenAPI\Client\Model\BriefVLANRequest',
        'status' => 'string',
    ...
    public const STATUS_CONTAINER = 'container';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['prefix']) && (mb_strlen($this->container['prefix']) < 1)) {
    ...
    public function setPrefix($prefix)
    {
        ...
        if ((mb_strlen($prefix) < 1)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling PatchedWritablePrefixRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets vlan
     *
     * @param \OpenAPI\Client\Model\BriefVLANRequest|null $vlan vlan
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Operational status of this prefix  * `container` - Container * `active` - Active * `reserved` - Reserved * `deprecated` - Deprecated
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritablePrefixRequest., must be smaller than or equal to 200.');
        }
