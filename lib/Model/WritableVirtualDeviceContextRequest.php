...
/**
 * WritableVirtualDeviceContextRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableVirtualDeviceContextRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableVirtualDeviceContextRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableVirtualDeviceContextRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WritableVirtualDeviceContextRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setIdentifier($identifier)
    {
        ...
        if (!is_null($identifier) && ($identifier > 32767)) {
            throw new \InvalidArgumentException('invalid value for $identifier when calling WritableVirtualDeviceContextRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($identifier) && ($identifier < 0)) {
            throw new \InvalidArgumentException('invalid value for $identifier when calling WritableVirtualDeviceContextRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets status
     *
     * @param string $status * `active` - Active * `planned` - Planned * `offline` - Offline
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableVirtualDeviceContextRequest., must be smaller than or equal to 200.');
        }
