...
/**
 * PatchedWritableWirelessLANRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableWirelessLANRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableWirelessLANRequest';
    ...
    protected static $openAPITypes = [
        'ssid' => 'string',
        'description' => 'string',
        'group' => '\OpenAPI\Client\Model\BriefWirelessLANGroupRequest',
        'status' => 'string',
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ssid']) && (mb_strlen($this->container['ssid']) < 1)) {
    ...
    public function setSsid($ssid)
    {
        ...
        if ((mb_strlen($ssid) > 32)) {
            throw new \InvalidArgumentException('invalid length for $ssid when calling PatchedWritableWirelessLANRequest., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($ssid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ssid when calling PatchedWritableWirelessLANRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableWirelessLANRequest., must be smaller than or equal to 200.');
        }
     ...
     * Gets group
     *
     * @return \OpenAPI\Client\Model\BriefWirelessLANGroupRequest|null
     */
     ...
     * Sets group
     *
     * @param \OpenAPI\Client\Model\BriefWirelessLANGroupRequest|null $group group
     *
     * @return self
     */
    ...
    public function setAuthPsk($auth_psk)
    {
        ...
        if ((mb_strlen($auth_psk) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_psk when calling PatchedWritableWirelessLANRequest., must be smaller than or equal to 64.');
        }
