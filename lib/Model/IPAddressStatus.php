...
/**
 * IPAddressStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class IPAddressStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IPAddress_status';
    ...
    public const VALUE_RESERVED = 'reserved';
    public const VALUE_DEPRECATED = 'deprecated';
    public const VALUE_DHCP = 'dhcp';
    public const VALUE_SLAAC = 'slaac';
    public const LABEL_ACTIVE = 'Active';
    public const LABEL_RESERVED = 'Reserved';
    public const LABEL_DEPRECATED = 'Deprecated';
    public const LABEL_DHCP = 'DHCP';
    public const LABEL_SLAAC = 'SLAAC';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `active` - Active * `reserved` - Reserved * `deprecated` - Deprecated * `dhcp` - DHCP * `slaac` - SLAAC
     *
     * @return self
     */
