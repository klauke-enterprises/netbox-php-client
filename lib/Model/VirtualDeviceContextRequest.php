...
/**
 * VirtualDeviceContextRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class VirtualDeviceContextRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VirtualDeviceContextRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VirtualDeviceContextRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling VirtualDeviceContextRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setIdentifier($identifier)
    {
        ...
        if (!is_null($identifier) && ($identifier > 32767)) {
            throw new \InvalidArgumentException('invalid value for $identifier when calling VirtualDeviceContextRequest., must be smaller than or equal to 32767.');
        }
        if (!is_null($identifier) && ($identifier < 0)) {
            throw new \InvalidArgumentException('invalid value for $identifier when calling VirtualDeviceContextRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VirtualDeviceContextRequest., must be smaller than or equal to 200.');
        }
