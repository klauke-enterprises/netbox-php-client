...
/**
 * ConsolePortTemplate Class Doc Comment
 *
 * @category Class
 ...
 */
class ConsolePortTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsolePortTemplate';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ConsolePortTemplate., must be smaller than or equal to 64.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ConsolePortTemplate., must be smaller than or equal to 64.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ConsolePortTemplate., must be smaller than or equal to 200.');
        }
