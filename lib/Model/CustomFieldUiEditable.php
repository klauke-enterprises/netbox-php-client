...
/**
 * CustomFieldUiEditable Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldUiEditable implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomField_ui_editable';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `yes` - Yes * `no` - No * `hidden` - Hidden
     *
     * @return self
     */
