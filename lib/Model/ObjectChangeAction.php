...
/**
 * ObjectChangeAction Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ObjectChangeAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ObjectChange_action';
    ...
    public const VALUE_CREATE = 'create';
    public const VALUE_UPDATE = 'update';
    public const VALUE_DELETE = 'delete';
    public const LABEL_CREATED = 'Created';
    public const LABEL_UPDATED = 'Updated';
    public const LABEL_DELETED = 'Deleted';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `create` - Created * `update` - Updated * `delete` - Deleted
     *
     * @return self
     */
