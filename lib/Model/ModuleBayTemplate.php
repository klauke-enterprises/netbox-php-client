...
/**
 * ModuleBayTemplate Class Doc Comment
 *
 * @category Class
 ...
 */
class ModuleBayTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModuleBayTemplate';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ModuleBayTemplate., must be smaller than or equal to 64.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling ModuleBayTemplate., must be smaller than or equal to 64.');
        }
    ...
    public function setPosition($position)
    {
        ...
        if ((mb_strlen($position) > 30)) {
            throw new \InvalidArgumentException('invalid length for $position when calling ModuleBayTemplate., must be smaller than or equal to 30.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling ModuleBayTemplate., must be smaller than or equal to 200.');
        }
