...
/**
 * TunnelStatus Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TunnelStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Tunnel_status';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `planned` - Planned * `active` - Active * `disabled` - Disabled
     *
     * @return self
     */
