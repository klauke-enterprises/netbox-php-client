...
/**
 * PatchedInventoryItemTemplateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedInventoryItemTemplateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedInventoryItemTemplateRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedInventoryItemTemplateRequest., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedInventoryItemTemplateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setLabel($label)
    {
        ...
        if ((mb_strlen($label) > 64)) {
            throw new \InvalidArgumentException('invalid length for $label when calling PatchedInventoryItemTemplateRequest., must be smaller than or equal to 64.');
        }
    ...
    public function setPartId($part_id)
    {
        ...
        if ((mb_strlen($part_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $part_id when calling PatchedInventoryItemTemplateRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedInventoryItemTemplateRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setComponentId($component_id)
    {
        ...
        if (!is_null($component_id) && ($component_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $component_id when calling PatchedInventoryItemTemplateRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($component_id) && ($component_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $component_id when calling PatchedInventoryItemTemplateRequest., must be bigger than or equal to 0.');
        }
