...
/**
 * TokenProvisionRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class TokenProvisionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TokenProvisionRequest';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TokenProvisionRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setUsername($username)
    {
        ...
        if ((mb_strlen($username) < 1)) {
            throw new \InvalidArgumentException('invalid length for $username when calling TokenProvisionRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 1)) {
            throw new \InvalidArgumentException('invalid length for $password when calling TokenProvisionRequest., must be bigger than or equal to 1.');
        }
