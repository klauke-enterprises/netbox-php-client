...
/**
 * CustomFieldUiVisible Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldUiVisible implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomField_ui_visible';
    ...
    public const VALUE_ALWAYS = 'always';
    public const VALUE_IF_SET = 'if-set';
    public const VALUE_HIDDEN = 'hidden';
    public const LABEL_ALWAYS = 'Always';
    public const LABEL_IF_SET = 'If set';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value * `always` - Always * `if-set` - If set * `hidden` - Hidden
     *
     * @return self
     */
