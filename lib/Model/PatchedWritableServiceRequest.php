...
/**
 * PatchedWritableServiceRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedWritableServiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PatchedWritableServiceRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableServiceRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PatchedWritableServiceRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets protocol
     *
     * @param string|null $protocol * `tcp` - TCP * `udp` - UDP * `sctp` - SCTP
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PatchedWritableServiceRequest., must be smaller than or equal to 200.');
        }
