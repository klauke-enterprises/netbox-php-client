...
class Tag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tagged_items', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tagged_items'] === null) {
            $invalidProperties[] = "'tagged_items' can't be null";
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Tag., must be smaller than or equal to 100.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling Tag., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/^[-\\w]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling Tag., must conform to the pattern /^[-\\w]+$/.");
        }
    ...
    public function setColor($color)
    {
        ...
        if ((mb_strlen($color) > 6)) {
            throw new \InvalidArgumentException('invalid length for $color when calling Tag., must be smaller than or equal to 6.');
        }
        if ((!preg_match("/^[0-9a-f]{6}$/", ObjectSerializer::toString($color)))) {
            throw new \InvalidArgumentException("invalid value for \$color when calling Tag., must conform to the pattern /^[0-9a-f]{6}$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Tag., must be smaller than or equal to 200.');
        }
    ...
    {
        return $this->container['tagged_items'];
    }

    /**
     * Sets tagged_items
     *
     * @param int $tagged_items tagged_items
     *
     * @return self
     */
    public function setTaggedItems($tagged_items)
    {
        if (is_null($tagged_items)) {
            throw new \InvalidArgumentException('non-nullable tagged_items cannot be null');
        }
        $this->container['tagged_items'] = $tagged_items;
