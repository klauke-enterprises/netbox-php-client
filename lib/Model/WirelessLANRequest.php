...
/**
 * WirelessLANRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WirelessLANRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WirelessLANRequest';
    ...
    */
    ...
    public function setSsid($ssid)
    {
        ...
        if ((mb_strlen($ssid) > 32)) {
            throw new \InvalidArgumentException('invalid length for $ssid when calling WirelessLANRequest., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($ssid) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ssid when calling WirelessLANRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WirelessLANRequest., must be smaller than or equal to 200.');
        }
    ...
    public function setAuthPsk($auth_psk)
    {
        ...
        if ((mb_strlen($auth_psk) > 64)) {
            throw new \InvalidArgumentException('invalid length for $auth_psk when calling WirelessLANRequest., must be smaller than or equal to 64.');
        }
