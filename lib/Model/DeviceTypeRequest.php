...
/**
 * DeviceTypeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class DeviceTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceTypeRequest';
    ...
    protected static $openAPITypes = [
        ...
        'default_platform' => '\OpenAPI\Client\Model\BriefPlatformRequest',
        'model' => 'string',
        'slug' => 'string',
        'part_number' => 'string',
        'u_height' => 'float',
    ...
    public const SUBDEVICE_ROLE_NULL = 'null';
    ...
    public const AIRFLOW_NULL = 'null';
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\BriefPlatformRequest|null $default_platform default_platform
     *
     * @return self
     */
    ...
    public function setModel($model)
    {
        ...
        if ((mb_strlen($model) > 100)) {
            throw new \InvalidArgumentException('invalid length for $model when calling DeviceTypeRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($model) < 1)) {
            throw new \InvalidArgumentException('invalid length for $model when calling DeviceTypeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSlug($slug)
    {
        ...
        if ((mb_strlen($slug) > 100)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling DeviceTypeRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($slug) < 1)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling DeviceTypeRequest., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[-a-zA-Z0-9_]+$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling DeviceTypeRequest., must conform to the pattern /^[-a-zA-Z0-9_]+$/.");
        }
    ...
    public function setPartNumber($part_number)
    {
        ...
        if ((mb_strlen($part_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $part_number when calling DeviceTypeRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setUHeight($u_height)
    {
        ...
        if (($u_height >= 1000)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling DeviceTypeRequest., must be smaller than 1000.');
        }
        if (($u_height < 0)) {
            throw new \InvalidArgumentException('invalid value for $u_height when calling DeviceTypeRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets subdevice_role
     *
     * @param string|null $subdevice_role * `parent` - Parent * `child` - Child
     *
     * @return self
     */
    public function setSubdeviceRole($subdevice_role)
    {
        ...
        $allowedValues = $this->getSubdeviceRoleAllowableValues();
        if (!is_null($subdevice_role) && !in_array($subdevice_role, $allowedValues, true)) {
    ...
    public function setAirflow($airflow)
    {
        ...
        $allowedValues = $this->getAirflowAllowableValues();
        if (!is_null($airflow) && !in_array($airflow, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'airflow', must be one of '%s'",
                    $airflow,
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling DeviceTypeRequest., must be smaller than 1000000.');
        }
        if (!is_null($weight) && ($weight <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling DeviceTypeRequest., must be bigger than -1000000.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DeviceTypeRequest., must be smaller than or equal to 200.');
        }
