...
/**
 * NestedIPAddressRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class NestedIPAddressRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NestedIPAddressRequest';
    ...
    */
    ...
    public function setAddress($address)
    {
        ...
        if ((mb_strlen($address) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address when calling NestedIPAddressRequest., must be bigger than or equal to 1.');
        }
