...
/**
 * WritableModuleTypeRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WritableModuleTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableModuleTypeRequest';
    ...
    */
    ...
    public function setModel($model)
    {
        ...
        if ((mb_strlen($model) > 100)) {
            throw new \InvalidArgumentException('invalid length for $model when calling WritableModuleTypeRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($model) < 1)) {
            throw new \InvalidArgumentException('invalid length for $model when calling WritableModuleTypeRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartNumber($part_number)
    {
        ...
        if ((mb_strlen($part_number) > 50)) {
            throw new \InvalidArgumentException('invalid length for $part_number when calling WritableModuleTypeRequest., must be smaller than or equal to 50.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight >= 1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling WritableModuleTypeRequest., must be smaller than 1000000.');
        }
        if (!is_null($weight) && ($weight <= -1000000)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling WritableModuleTypeRequest., must be bigger than -1000000.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling WritableModuleTypeRequest., must be smaller than or equal to 200.');
        }
