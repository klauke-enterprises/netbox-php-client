...
| **type_id__n** | [**int[]**](../Model/int.md)| Cluster type (ID) | [optional] |
| **updated_by_request** | **string**|  | [optional] |
...
try {
    $result = $apiInstance->virtualizationClustersRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationClustersRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationClustersUpdate($id, $writable_cluster_request): \OpenAPI\Client\Model\Cluster
```
...
try {
    $result = $apiInstance->virtualizationClustersUpdate($id, $writable_cluster_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationClustersUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationInterfacesBulkDestroy($vm_interface_request)
```
...
$vm_interface_request = array(new \OpenAPI\Client\Model\VMInterfaceRequest()); // \OpenAPI\Client\Model\VMInterfaceRequest[]

try {
    $apiInstance->virtualizationInterfacesBulkDestroy($vm_interface_request);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesBulkDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **vm_interface_request** | [**\OpenAPI\Client\Model\VMInterfaceRequest[]**](../Model/VMInterfaceRequest.md)|  | |
...
```php
virtualizationInterfacesBulkPartialUpdate($vm_interface_request): \OpenAPI\Client\Model\VMInterface[]
```
...
try {
    $result = $apiInstance->virtualizationInterfacesBulkPartialUpdate($vm_interface_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesBulkPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\VMInterface[]**](../Model/VMInterface.md)
...
```php
virtualizationInterfacesBulkUpdate($vm_interface_request): \OpenAPI\Client\Model\VMInterface[]
```
...
try {
    $result = $apiInstance->virtualizationInterfacesBulkUpdate($vm_interface_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesBulkUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationInterfacesCreate($writable_vm_interface_request): \OpenAPI\Client\Model\VMInterface
```
...
$writable_vm_interface_request = new \OpenAPI\Client\Model\WritableVMInterfaceRequest(); // \OpenAPI\Client\Model\WritableVMInterfaceRequest

try {
    $result = $apiInstance->virtualizationInterfacesCreate($writable_vm_interface_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **writable_vm_interface_request** | [**\OpenAPI\Client\Model\WritableVMInterfaceRequest**](../Model/WritableVMInterfaceRequest.md)|  | |
...
```php
virtualizationInterfacesDestroy($id)
```
...
try {
    $apiInstance->virtualizationInterfacesDestroy($id);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
$bridge_id = array(56); // int[] | Bridged interface (ID)
$bridge_id__n = array(56); // int[] | Bridged interface (ID)
...
$mode = 'mode_example'; // string | IEEE 802.1Q tagging strategy  * `access` - Access * `tagged` - Tagged * `tagged-all` - Tagged (All)
$mode__n = 'mode__n_example'; // string | IEEE 802.1Q tagging strategy  * `access` - Access * `tagged` - Tagged * `tagged-all` - Tagged (All)
$modified_by_request = 'modified_by_request_example'; // string
$mtu = array(56); // int[]
$mtu__empty = True; // bool
$mtu__gt = array(56); // int[]
$mtu__gte = array(56); // int[]
$mtu__lt = array(56); // int[]
$mtu__lte = array(56); // int[]
$mtu__n = array(56); // int[]
$name = array('name_example'); // string[]
$name__empty = True; // bool
$name__ic = array('name__ic_example'); // string[]
...
$offset = 56; // int | The initial index from which to return the results.
$ordering = 'ordering_example'; // string | Which field to use when ordering the results.
$parent_id = array(56); // int[] | Parent interface (ID)
$parent_id__n = array(56); // int[] | Parent interface (ID)
$q = 'q_example'; // string | Search
$tag = array('tag_example'); // string[]
$tag__n = array('tag__n_example'); // string[]
$updated_by_request = 'updated_by_request_example'; // string
$virtual_machine = array('virtual_machine_example'); // string[] | Virtual machine
$virtual_machine__n = array('virtual_machine__n_example'); // string[] | Virtual machine
$virtual_machine_id = array(56); // int[] | Virtual machine (ID)
$virtual_machine_id__n = array(56); // int[] | Virtual machine (ID)
$vlan = 'vlan_example'; // string | Assigned VID
$vlan_id = 'vlan_id_example'; // string | Assigned VLAN
...
try {
    $result = $apiInstance->virtualizationInterfacesList($bridge_id, $bridge_id__n, $cluster, $cluster__n, $cluster_id, $cluster_id__n, $created, $created__empty, $created__gt, $created__gte, $created__lt, $created__lte, $created__n, $created_by_request, $description, $description__empty, $description__ic, $description__ie, $description__iew, $description__isw, $description__n, $description__nic, $description__nie, $description__niew, $description__nisw, $enabled, $id, $id__empty, $id__gt, $id__gte, $id__lt, $id__lte, $id__n, $l2vpn, $l2vpn__n, $l2vpn_id, $l2vpn_id__n, $last_updated, $last_updated__empty, $last_updated__gt, $last_updated__gte, $last_updated__lt, $last_updated__lte, $last_updated__n, $limit, $mac_address, $mac_address__ic, $mac_address__ie, $mac_address__iew, $mac_address__isw, $mac_address__n, $mac_address__nic, $mac_address__nie, $mac_address__niew, $mac_address__nisw, $mode, $mode__n, $modified_by_request, $mtu, $mtu__empty, $mtu__gt, $mtu__gte, $mtu__lt, $mtu__lte, $mtu__n, $name, $name__empty, $name__ic, $name__ie, $name__iew, $name__isw, $name__n, $name__nic, $name__nie, $name__niew, $name__nisw, $offset, $ordering, $parent_id, $parent_id__n, $q, $tag, $tag__n, $updated_by_request, $virtual_machine, $virtual_machine__n, $virtual_machine_id, $virtual_machine_id__n, $vlan, $vlan_id, $vrf, $vrf__n, $vrf_id, $vrf_id__n);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesList: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **bridge_id** | [**int[]**](../Model/int.md)| Bridged interface (ID) | [optional] |
| **bridge_id__n** | [**int[]**](../Model/int.md)| Bridged interface (ID) | [optional] |
...
| **mode__n** | **string**| IEEE 802.1Q tagging strategy  * &#x60;access&#x60; - Access * &#x60;tagged&#x60; - Tagged * &#x60;tagged-all&#x60; - Tagged (All) | [optional] |
| **modified_by_request** | **string**|  | [optional] |
| **mtu** | [**int[]**](../Model/int.md)|  | [optional] |
| **mtu__empty** | **bool**|  | [optional] |
| **mtu__gt** | [**int[]**](../Model/int.md)|  | [optional] |
| **mtu__gte** | [**int[]**](../Model/int.md)|  | [optional] |
| **mtu__lt** | [**int[]**](../Model/int.md)|  | [optional] |
| **mtu__lte** | [**int[]**](../Model/int.md)|  | [optional] |
| **mtu__n** | [**int[]**](../Model/int.md)|  | [optional] |
| **name** | [**string[]**](../Model/string.md)|  | [optional] |
| **name__empty** | **bool**|  | [optional] |
| **name__ic** | [**string[]**](../Model/string.md)|  | [optional] |
| **name__ie** | [**string[]**](../Model/string.md)|  | [optional] |
...
| **offset** | **int**| The initial index from which to return the results. | [optional] |
| **ordering** | **string**| Which field to use when ordering the results. | [optional] |
| **parent_id** | [**int[]**](../Model/int.md)| Parent interface (ID) | [optional] |
| **parent_id__n** | [**int[]**](../Model/int.md)| Parent interface (ID) | [optional] |
| **q** | **string**| Search | [optional] |
| **tag** | [**string[]**](../Model/string.md)|  | [optional] |
| **tag__n** | [**string[]**](../Model/string.md)|  | [optional] |
| **updated_by_request** | **string**|  | [optional] |
| **virtual_machine** | [**string[]**](../Model/string.md)| Virtual machine | [optional] |
| **virtual_machine__n** | [**string[]**](../Model/string.md)| Virtual machine | [optional] |
...
| **vlan** | **string**| Assigned VID | [optional] |
| **vlan_id** | **string**| Assigned VLAN | [optional] |
...
[**\OpenAPI\Client\Model\PaginatedVMInterfaceList**](../Model/PaginatedVMInterfaceList.md)
...
```php
virtualizationInterfacesPartialUpdate($id, $patched_writable_vm_interface_request): \OpenAPI\Client\Model\VMInterface
```
...
$id = 56; // int | A unique integer value identifying this interface.
$patched_writable_vm_interface_request = new \OpenAPI\Client\Model\PatchedWritableVMInterfaceRequest(); // \OpenAPI\Client\Model\PatchedWritableVMInterfaceRequest

try {
    $result = $apiInstance->virtualizationInterfacesPartialUpdate($id, $patched_writable_vm_interface_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this interface. | |
| **patched_writable_vm_interface_request** | [**\OpenAPI\Client\Model\PatchedWritableVMInterfaceRequest**](../Model/PatchedWritableVMInterfaceRequest.md)|  | [optional] |
...
```php
virtualizationInterfacesRetrieve($id): \OpenAPI\Client\Model\VMInterface
```
...
try {
    $result = $apiInstance->virtualizationInterfacesRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationInterfacesUpdate($id, $writable_vm_interface_request): \OpenAPI\Client\Model\VMInterface
```
...
try {
    $result = $apiInstance->virtualizationInterfacesUpdate($id, $writable_vm_interface_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationInterfacesUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationVirtualDisksBulkDestroy($virtual_disk_request)
```
...
$virtual_disk_request = array(new \OpenAPI\Client\Model\VirtualDiskRequest()); // \OpenAPI\Client\Model\VirtualDiskRequest[]

try {
    $apiInstance->virtualizationVirtualDisksBulkDestroy($virtual_disk_request);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksBulkDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **virtual_disk_request** | [**\OpenAPI\Client\Model\VirtualDiskRequest[]**](../Model/VirtualDiskRequest.md)|  | |
...
```php
virtualizationVirtualDisksBulkPartialUpdate($virtual_disk_request): \OpenAPI\Client\Model\VirtualDisk[]
```
...
try {
    $result = $apiInstance->virtualizationVirtualDisksBulkPartialUpdate($virtual_disk_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksBulkPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\VirtualDisk[]**](../Model/VirtualDisk.md)
...
```php
virtualizationVirtualDisksBulkUpdate($virtual_disk_request): \OpenAPI\Client\Model\VirtualDisk[]
```
...
try {
    $result = $apiInstance->virtualizationVirtualDisksBulkUpdate($virtual_disk_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksBulkUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationVirtualDisksCreate($virtual_disk_request): \OpenAPI\Client\Model\VirtualDisk
```
...
$virtual_disk_request = new \OpenAPI\Client\Model\VirtualDiskRequest(); // \OpenAPI\Client\Model\VirtualDiskRequest

try {
    $result = $apiInstance->virtualizationVirtualDisksCreate($virtual_disk_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationVirtualDisksDestroy($id)
```
...
$id = 56; // int | A unique integer value identifying this virtual disk.

try {
    $apiInstance->virtualizationVirtualDisksDestroy($id);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this virtual disk. | |
...
try {
    $result = $apiInstance->virtualizationVirtualDisksList($created, $created__empty, $created__gt, $created__gte, $created__lt, $created__lte, $created__n, $created_by_request, $description, $description__empty, $description__ic, $description__ie, $description__iew, $description__isw, $description__n, $description__nic, $description__nie, $description__niew, $description__nisw, $id, $id__empty, $id__gt, $id__gte, $id__lt, $id__lte, $id__n, $last_updated, $last_updated__empty, $last_updated__gt, $last_updated__gte, $last_updated__lt, $last_updated__lte, $last_updated__n, $limit, $modified_by_request, $name, $name__empty, $name__ic, $name__ie, $name__iew, $name__isw, $name__n, $name__nic, $name__nie, $name__niew, $name__nisw, $offset, $ordering, $q, $size, $size__empty, $size__gt, $size__gte, $size__lt, $size__lte, $size__n, $tag, $tag__n, $updated_by_request, $virtual_machine, $virtual_machine__n, $virtual_machine_id, $virtual_machine_id__n);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksList: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\PaginatedVirtualDiskList**](../Model/PaginatedVirtualDiskList.md)
...
```php
virtualizationVirtualDisksPartialUpdate($id, $patched_virtual_disk_request): \OpenAPI\Client\Model\VirtualDisk
```
...
$id = 56; // int | A unique integer value identifying this virtual disk.
$patched_virtual_disk_request = new \OpenAPI\Client\Model\PatchedVirtualDiskRequest(); // \OpenAPI\Client\Model\PatchedVirtualDiskRequest

try {
    $result = $apiInstance->virtualizationVirtualDisksPartialUpdate($id, $patched_virtual_disk_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this virtual disk. | |
| **patched_virtual_disk_request** | [**\OpenAPI\Client\Model\PatchedVirtualDiskRequest**](../Model/PatchedVirtualDiskRequest.md)|  | [optional] |
...
```php
virtualizationVirtualDisksRetrieve($id): \OpenAPI\Client\Model\VirtualDisk
```
...
try {
    $result = $apiInstance->virtualizationVirtualDisksRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationVirtualDisksUpdate($id, $virtual_disk_request): \OpenAPI\Client\Model\VirtualDisk
```
...
try {
    $result = $apiInstance->virtualizationVirtualDisksUpdate($id, $virtual_disk_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualDisksUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationVirtualMachinesBulkDestroy($virtual_machine_with_config_context_request)
```
...
$virtual_machine_with_config_context_request = array(new \OpenAPI\Client\Model\VirtualMachineWithConfigContextRequest()); // \OpenAPI\Client\Model\VirtualMachineWithConfigContextRequest[]

try {
    $apiInstance->virtualizationVirtualMachinesBulkDestroy($virtual_machine_with_config_context_request);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesBulkDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **virtual_machine_with_config_context_request** | [**\OpenAPI\Client\Model\VirtualMachineWithConfigContextRequest[]**](../Model/VirtualMachineWithConfigContextRequest.md)|  | |
...
```php
virtualizationVirtualMachinesBulkPartialUpdate($virtual_machine_with_config_context_request): \OpenAPI\Client\Model\VirtualMachineWithConfigContext[]
```
...
try {
    $result = $apiInstance->virtualizationVirtualMachinesBulkPartialUpdate($virtual_machine_with_config_context_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesBulkPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\VirtualMachineWithConfigContext[]**](../Model/VirtualMachineWithConfigContext.md)
...
```php
virtualizationVirtualMachinesBulkUpdate($virtual_machine_with_config_context_request): \OpenAPI\Client\Model\VirtualMachineWithConfigContext[]
```
...
try {
    $result = $apiInstance->virtualizationVirtualMachinesBulkUpdate($virtual_machine_with_config_context_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesBulkUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationVirtualMachinesCreate($writable_virtual_machine_with_config_context_request): \OpenAPI\Client\Model\VirtualMachineWithConfigContext
```
...
$writable_virtual_machine_with_config_context_request = new \OpenAPI\Client\Model\WritableVirtualMachineWithConfigContextRequest(); // \OpenAPI\Client\Model\WritableVirtualMachineWithConfigContextRequest

try {
    $result = $apiInstance->virtualizationVirtualMachinesCreate($writable_virtual_machine_with_config_context_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **writable_virtual_machine_with_config_context_request** | [**\OpenAPI\Client\Model\WritableVirtualMachineWithConfigContextRequest**](../Model/WritableVirtualMachineWithConfigContextRequest.md)|  | |
...
```php
virtualizationVirtualMachinesDestroy($id)
```
...
try {
    $apiInstance->virtualizationVirtualMachinesDestroy($id);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\PaginatedVirtualMachineWithConfigContextList**](../Model/PaginatedVirtualMachineWithConfigContextList.md)
...
```php
virtualizationVirtualMachinesPartialUpdate($id, $patched_writable_virtual_machine_with_config_context_request): \OpenAPI\Client\Model\VirtualMachineWithConfigContext
```
...
$id = 56; // int | A unique integer value identifying this virtual machine.
$patched_writable_virtual_machine_with_config_context_request = new \OpenAPI\Client\Model\PatchedWritableVirtualMachineWithConfigContextRequest(); // \OpenAPI\Client\Model\PatchedWritableVirtualMachineWithConfigContextRequest

try {
    $result = $apiInstance->virtualizationVirtualMachinesPartialUpdate($id, $patched_writable_virtual_machine_with_config_context_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this virtual machine. | |
| **patched_writable_virtual_machine_with_config_context_request** | [**\OpenAPI\Client\Model\PatchedWritableVirtualMachineWithConfigContextRequest**](../Model/PatchedWritableVirtualMachineWithConfigContextRequest.md)|  | [optional] |
...
```php
virtualizationVirtualMachinesRenderConfigCreate($id, $writable_virtual_machine_with_config_context_request, $format): \OpenAPI\Client\Model\VirtualMachineWithConfigContext
```
...
try {
    $result = $apiInstance->virtualizationVirtualMachinesRenderConfigCreate($id, $writable_virtual_machine_with_config_context_request, $format);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesRenderConfigCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationVirtualMachinesRetrieve($id): \OpenAPI\Client\Model\VirtualMachineWithConfigContext
```
...
try {
    $result = $apiInstance->virtualizationVirtualMachinesRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
virtualizationVirtualMachinesUpdate($id, $writable_virtual_machine_with_config_context_request): \OpenAPI\Client\Model\VirtualMachineWithConfigContext
```
...
try {
    $result = $apiInstance->virtualizationVirtualMachinesUpdate($id, $writable_virtual_machine_with_config_context_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling VirtualizationApi->virtualizationVirtualMachinesUpdate: ', $e->getMessage(), PHP_EOL;
}
```
