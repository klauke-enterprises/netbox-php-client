...
$id = 56; // int | A unique integer value identifying this circuit termination.
$patched_circuit_termination_request = new \OpenAPI\Client\Model\PatchedCircuitTerminationRequest(); // \OpenAPI\Client\Model\PatchedCircuitTerminationRequest

try {
    $result = $apiInstance->circuitsCircuitTerminationsPartialUpdate($id, $patched_circuit_termination_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTerminationsPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this circuit termination. | |
| **patched_circuit_termination_request** | [**\OpenAPI\Client\Model\PatchedCircuitTerminationRequest**](../Model/PatchedCircuitTerminationRequest.md)|  | [optional] |
...
```php
circuitsCircuitTerminationsPathsRetrieve($id): \OpenAPI\Client\Model\CircuitTermination
```
...
try {
    $result = $apiInstance->circuitsCircuitTerminationsPathsRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTerminationsPathsRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitTerminationsRetrieve($id): \OpenAPI\Client\Model\CircuitTermination
```
...
try {
    $result = $apiInstance->circuitsCircuitTerminationsRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTerminationsRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitTerminationsUpdate($id, $circuit_termination_request): \OpenAPI\Client\Model\CircuitTermination
```
...
try {
    $result = $apiInstance->circuitsCircuitTerminationsUpdate($id, $circuit_termination_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTerminationsUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitTypesBulkDestroy($circuit_type_request)
```
...
$circuit_type_request = array(new \OpenAPI\Client\Model\CircuitTypeRequest()); // \OpenAPI\Client\Model\CircuitTypeRequest[]

try {
    $apiInstance->circuitsCircuitTypesBulkDestroy($circuit_type_request);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesBulkDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **circuit_type_request** | [**\OpenAPI\Client\Model\CircuitTypeRequest[]**](../Model/CircuitTypeRequest.md)|  | |
...
```php
circuitsCircuitTypesBulkPartialUpdate($circuit_type_request): \OpenAPI\Client\Model\CircuitType[]
```
...
try {
    $result = $apiInstance->circuitsCircuitTypesBulkPartialUpdate($circuit_type_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesBulkPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\CircuitType[]**](../Model/CircuitType.md)
...
```php
circuitsCircuitTypesBulkUpdate($circuit_type_request): \OpenAPI\Client\Model\CircuitType[]
```
...
try {
    $result = $apiInstance->circuitsCircuitTypesBulkUpdate($circuit_type_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesBulkUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitTypesCreate($circuit_type_request): \OpenAPI\Client\Model\CircuitType
```
...
$circuit_type_request = new \OpenAPI\Client\Model\CircuitTypeRequest(); // \OpenAPI\Client\Model\CircuitTypeRequest

try {
    $result = $apiInstance->circuitsCircuitTypesCreate($circuit_type_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitTypesDestroy($id)
```
...
try {
    $apiInstance->circuitsCircuitTypesDestroy($id);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitTypesList($color, $color__empty, $color__ic, $color__ie, $color__iew, $color__isw, $color__n, $color__nic, $color__nie, $color__niew, $color__nisw, $created, $created__empty, $created__gt, $created__gte, $created__lt, $created__lte, $created__n, $created_by_request, $description, $description__empty, $description__ic, $description__ie, $description__iew, $description__isw, $description__n, $description__nic, $description__nie, $description__niew, $description__nisw, $id, $id__empty, $id__gt, $id__gte, $id__lt, $id__lte, $id__n, $last_updated, $last_updated__empty, $last_updated__gt, $last_updated__gte, $last_updated__lt, $last_updated__lte, $last_updated__n, $limit, $modified_by_request, $name, $name__empty, $name__ic, $name__ie, $name__iew, $name__isw, $name__n, $name__nic, $name__nie, $name__niew, $name__nisw, $offset, $ordering, $q, $slug, $slug__empty, $slug__ic, $slug__ie, $slug__iew, $slug__isw, $slug__n, $slug__nic, $slug__nie, $slug__niew, $slug__nisw, $tag, $tag__n, $updated_by_request): \OpenAPI\Client\Model\PaginatedCircuitTypeList
```
...
try {
    $result = $apiInstance->circuitsCircuitTypesList($color, $color__empty, $color__ic, $color__ie, $color__iew, $color__isw, $color__n, $color__nic, $color__nie, $color__niew, $color__nisw, $created, $created__empty, $created__gt, $created__gte, $created__lt, $created__lte, $created__n, $created_by_request, $description, $description__empty, $description__ic, $description__ie, $description__iew, $description__isw, $description__n, $description__nic, $description__nie, $description__niew, $description__nisw, $id, $id__empty, $id__gt, $id__gte, $id__lt, $id__lte, $id__n, $last_updated, $last_updated__empty, $last_updated__gt, $last_updated__gte, $last_updated__lt, $last_updated__lte, $last_updated__n, $limit, $modified_by_request, $name, $name__empty, $name__ic, $name__ie, $name__iew, $name__isw, $name__n, $name__nic, $name__nie, $name__niew, $name__nisw, $offset, $ordering, $q, $slug, $slug__empty, $slug__ic, $slug__ie, $slug__iew, $slug__isw, $slug__n, $slug__nic, $slug__nie, $slug__niew, $slug__nisw, $tag, $tag__n, $updated_by_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesList: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\PaginatedCircuitTypeList**](../Model/PaginatedCircuitTypeList.md)
...
```php
circuitsCircuitTypesPartialUpdate($id, $patched_circuit_type_request): \OpenAPI\Client\Model\CircuitType
```
...
$id = 56; // int | A unique integer value identifying this circuit type.
$patched_circuit_type_request = new \OpenAPI\Client\Model\PatchedCircuitTypeRequest(); // \OpenAPI\Client\Model\PatchedCircuitTypeRequest

try {
    $result = $apiInstance->circuitsCircuitTypesPartialUpdate($id, $patched_circuit_type_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this circuit type. | |
| **patched_circuit_type_request** | [**\OpenAPI\Client\Model\PatchedCircuitTypeRequest**](../Model/PatchedCircuitTypeRequest.md)|  | [optional] |
...
```php
circuitsCircuitTypesRetrieve($id): \OpenAPI\Client\Model\CircuitType
```
...
try {
    $result = $apiInstance->circuitsCircuitTypesRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitTypesUpdate($id, $circuit_type_request): \OpenAPI\Client\Model\CircuitType
```
...
try {
    $result = $apiInstance->circuitsCircuitTypesUpdate($id, $circuit_type_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitTypesUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitsBulkDestroy($circuit_request)
```
...
$circuit_request = array(new \OpenAPI\Client\Model\CircuitRequest()); // \OpenAPI\Client\Model\CircuitRequest[]

try {
    $apiInstance->circuitsCircuitsBulkDestroy($circuit_request);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsBulkDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **circuit_request** | [**\OpenAPI\Client\Model\CircuitRequest[]**](../Model/CircuitRequest.md)|  | |
...
```php
circuitsCircuitsBulkPartialUpdate($circuit_request): \OpenAPI\Client\Model\Circuit[]
```
...
try {
    $result = $apiInstance->circuitsCircuitsBulkPartialUpdate($circuit_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsBulkPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\Circuit[]**](../Model/Circuit.md)
...
```php
circuitsCircuitsBulkUpdate($circuit_request): \OpenAPI\Client\Model\Circuit[]
```
...
try {
    $result = $apiInstance->circuitsCircuitsBulkUpdate($circuit_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsBulkUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitsCreate($writable_circuit_request): \OpenAPI\Client\Model\Circuit
```
...
$writable_circuit_request = new \OpenAPI\Client\Model\WritableCircuitRequest(); // \OpenAPI\Client\Model\WritableCircuitRequest

try {
    $result = $apiInstance->circuitsCircuitsCreate($writable_circuit_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **writable_circuit_request** | [**\OpenAPI\Client\Model\WritableCircuitRequest**](../Model/WritableCircuitRequest.md)|  | |
...
try {
    $apiInstance->circuitsCircuitsDestroy($id);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
$cid = array('cid_example'); // string[]
$cid__empty = True; // bool
$cid__ic = array('cid__ic_example'); // string[]
$cid__ie = array('cid__ie_example'); // string[]
$cid__iew = array('cid__iew_example'); // string[]
$cid__isw = array('cid__isw_example'); // string[]
$cid__n = array('cid__n_example'); // string[]
$cid__nic = array('cid__nic_example'); // string[]
$cid__nie = array('cid__nie_example'); // string[]
$cid__niew = array('cid__niew_example'); // string[]
$cid__nisw = array('cid__nisw_example'); // string[]
$commit_rate = array(56); // int[]
$commit_rate__empty = True; // bool
$commit_rate__gt = array(56); // int[]
$commit_rate__gte = array(56); // int[]
$commit_rate__lt = array(56); // int[]
$commit_rate__lte = array(56); // int[]
$commit_rate__n = array(56); // int[]
...
$id__lte = array(56); // int[]
$id__n = array(56); // int[]
$install_date = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$install_date__empty = True; // bool
$install_date__gt = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$install_date__gte = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$install_date__lt = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$install_date__lte = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$install_date__n = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$last_updated = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$last_updated__empty = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$last_updated__gt = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$last_updated__gte = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
...
$provider = array('provider_example'); // string[] | Provider (slug)
$provider__n = array('provider__n_example'); // string[] | Provider (slug)
$provider_account = array('provider_account_example'); // string[] | Provider account (account)
$provider_account__n = array('provider_account__n_example'); // string[] | Provider account (account)
$provider_account_id = array(56); // int[] | Provider account (ID)
$provider_account_id__n = array(56); // int[] | Provider account (ID)
$provider_id = array(56); // int[] | Provider (ID)
$provider_id__n = array(56); // int[] | Provider (ID)
$provider_network_id = array(56); // int[] | Provider network (ID)
$provider_network_id__n = array(56); // int[] | Provider network (ID)
$q = 'q_example'; // string | Search
...
$tenant_id = array(56); // int[] | Tenant (ID)
$tenant_id__n = array(56); // int[] | Tenant (ID)
$termination_a_id = array(56); // int[] | Termination A (ID)
$termination_a_id__n = array(56); // int[] | Termination A (ID)
$termination_date = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$termination_date__empty = True; // bool
$termination_date__gt = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$termination_date__gte = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$termination_date__lt = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$termination_date__lte = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$termination_date__n = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$termination_z_id = array(56); // int[] | Termination A (ID)
$termination_z_id__n = array(56); // int[] | Termination A (ID)
$type = array('type_example'); // string[] | Circuit type (slug)
$type__n = array('type__n_example'); // string[] | Circuit type (slug)
$type_id = array(56); // int[] | Circuit type (ID)
$type_id__n = array(56); // int[] | Circuit type (ID)
$updated_by_request = 'updated_by_request_example'; // string

try {
    $result = $apiInstance->circuitsCircuitsList($cid, $cid__empty, $cid__ic, $cid__ie, $cid__iew, $cid__isw, $cid__n, $cid__nic, $cid__nie, $cid__niew, $cid__nisw, $commit_rate, $commit_rate__empty, $commit_rate__gt, $commit_rate__gte, $commit_rate__lt, $commit_rate__lte, $commit_rate__n, $contact, $contact__n, $contact_group, $contact_group__n, $contact_role, $contact_role__n, $created, $created__empty, $created__gt, $created__gte, $created__lt, $created__lte, $created__n, $created_by_request, $description, $description__empty, $description__ic, $description__ie, $description__iew, $description__isw, $description__n, $description__nic, $description__nie, $description__niew, $description__nisw, $id, $id__empty, $id__gt, $id__gte, $id__lt, $id__lte, $id__n, $install_date, $install_date__empty, $install_date__gt, $install_date__gte, $install_date__lt, $install_date__lte, $install_date__n, $last_updated, $last_updated__empty, $last_updated__gt, $last_updated__gte, $last_updated__lt, $last_updated__lte, $last_updated__n, $limit, $modified_by_request, $offset, $ordering, $provider, $provider__n, $provider_account, $provider_account__n, $provider_account_id, $provider_account_id__n, $provider_id, $provider_id__n, $provider_network_id, $provider_network_id__n, $q, $region, $region__n, $region_id, $region_id__n, $site, $site__n, $site_group, $site_group__n, $site_group_id, $site_group_id__n, $site_id, $site_id__n, $status, $status__n, $tag, $tag__n, $tenant, $tenant__n, $tenant_group, $tenant_group__n, $tenant_group_id, $tenant_group_id__n, $tenant_id, $tenant_id__n, $termination_a_id, $termination_a_id__n, $termination_date, $termination_date__empty, $termination_date__gt, $termination_date__gte, $termination_date__lt, $termination_date__lte, $termination_date__n, $termination_z_id, $termination_z_id__n, $type, $type__n, $type_id, $type_id__n, $updated_by_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsList: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **cid** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__empty** | **bool**|  | [optional] |
| **cid__ic** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__ie** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__iew** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__isw** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__n** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__nic** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__nie** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__niew** | [**string[]**](../Model/string.md)|  | [optional] |
| **cid__nisw** | [**string[]**](../Model/string.md)|  | [optional] |
| **commit_rate** | [**int[]**](../Model/int.md)|  | [optional] |
| **commit_rate__empty** | **bool**|  | [optional] |
| **commit_rate__gt** | [**int[]**](../Model/int.md)|  | [optional] |
| **commit_rate__gte** | [**int[]**](../Model/int.md)|  | [optional] |
| **commit_rate__lt** | [**int[]**](../Model/int.md)|  | [optional] |
| **commit_rate__lte** | [**int[]**](../Model/int.md)|  | [optional] |
| **commit_rate__n** | [**int[]**](../Model/int.md)|  | [optional] |
...
| **id__lte** | [**int[]**](../Model/int.md)|  | [optional] |
| **id__n** | [**int[]**](../Model/int.md)|  | [optional] |
| **install_date** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **install_date__empty** | **bool**|  | [optional] |
| **install_date__gt** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **install_date__gte** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **install_date__lt** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **install_date__lte** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **install_date__n** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **last_updated** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **last_updated__empty** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **last_updated__gt** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **last_updated__gte** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
...
| **provider** | [**string[]**](../Model/string.md)| Provider (slug) | [optional] |
| **provider__n** | [**string[]**](../Model/string.md)| Provider (slug) | [optional] |
| **provider_account** | [**string[]**](../Model/string.md)| Provider account (account) | [optional] |
| **provider_account__n** | [**string[]**](../Model/string.md)| Provider account (account) | [optional] |
| **provider_account_id** | [**int[]**](../Model/int.md)| Provider account (ID) | [optional] |
| **provider_account_id__n** | [**int[]**](../Model/int.md)| Provider account (ID) | [optional] |
| **provider_id** | [**int[]**](../Model/int.md)| Provider (ID) | [optional] |
| **provider_id__n** | [**int[]**](../Model/int.md)| Provider (ID) | [optional] |
| **provider_network_id** | [**int[]**](../Model/int.md)| Provider network (ID) | [optional] |
| **provider_network_id__n** | [**int[]**](../Model/int.md)| Provider network (ID) | [optional] |
| **q** | **string**| Search | [optional] |
...
| **tenant_id** | [**int[]**](../Model/int.md)| Tenant (ID) | [optional] |
| **tenant_id__n** | [**int[]**](../Model/int.md)| Tenant (ID) | [optional] |
| **termination_a_id** | [**int[]**](../Model/int.md)| Termination A (ID) | [optional] |
| **termination_a_id__n** | [**int[]**](../Model/int.md)| Termination A (ID) | [optional] |
| **termination_date** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **termination_date__empty** | **bool**|  | [optional] |
| **termination_date__gt** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **termination_date__gte** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **termination_date__lt** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **termination_date__lte** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **termination_date__n** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **termination_z_id** | [**int[]**](../Model/int.md)| Termination A (ID) | [optional] |
| **termination_z_id__n** | [**int[]**](../Model/int.md)| Termination A (ID) | [optional] |
| **type** | [**string[]**](../Model/string.md)| Circuit type (slug) | [optional] |
| **type__n** | [**string[]**](../Model/string.md)| Circuit type (slug) | [optional] |
| **type_id** | [**int[]**](../Model/int.md)| Circuit type (ID) | [optional] |
| **type_id__n** | [**int[]**](../Model/int.md)| Circuit type (ID) | [optional] |
| **updated_by_request** | **string**|  | [optional] |

### Return type

[**\OpenAPI\Client\Model\PaginatedCircuitList**](../Model/PaginatedCircuitList.md)
...
```php
circuitsCircuitsPartialUpdate($id, $patched_writable_circuit_request): \OpenAPI\Client\Model\Circuit
```
...
$id = 56; // int | A unique integer value identifying this circuit.
$patched_writable_circuit_request = new \OpenAPI\Client\Model\PatchedWritableCircuitRequest(); // \OpenAPI\Client\Model\PatchedWritableCircuitRequest

try {
    $result = $apiInstance->circuitsCircuitsPartialUpdate($id, $patched_writable_circuit_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this circuit. | |
| **patched_writable_circuit_request** | [**\OpenAPI\Client\Model\PatchedWritableCircuitRequest**](../Model/PatchedWritableCircuitRequest.md)|  | [optional] |
...
```php
circuitsCircuitsRetrieve($id): \OpenAPI\Client\Model\Circuit
```
...
try {
    $result = $apiInstance->circuitsCircuitsRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsCircuitsUpdate($id, $writable_circuit_request): \OpenAPI\Client\Model\Circuit
```
...
try {
    $result = $apiInstance->circuitsCircuitsUpdate($id, $writable_circuit_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsCircuitsUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProviderAccountsBulkDestroy($provider_account_request)
```
...
$provider_account_request = array(new \OpenAPI\Client\Model\ProviderAccountRequest()); // \OpenAPI\Client\Model\ProviderAccountRequest[]

try {
    $apiInstance->circuitsProviderAccountsBulkDestroy($provider_account_request);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsBulkDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **provider_account_request** | [**\OpenAPI\Client\Model\ProviderAccountRequest[]**](../Model/ProviderAccountRequest.md)|  | |
...
```php
circuitsProviderAccountsBulkPartialUpdate($provider_account_request): \OpenAPI\Client\Model\ProviderAccount[]
```
...
try {
    $result = $apiInstance->circuitsProviderAccountsBulkPartialUpdate($provider_account_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsBulkPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ProviderAccount[]**](../Model/ProviderAccount.md)
...
```php
circuitsProviderAccountsBulkUpdate($provider_account_request): \OpenAPI\Client\Model\ProviderAccount[]
```
...
try {
    $result = $apiInstance->circuitsProviderAccountsBulkUpdate($provider_account_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsBulkUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProviderAccountsCreate($provider_account_request): \OpenAPI\Client\Model\ProviderAccount
```
...
$provider_account_request = new \OpenAPI\Client\Model\ProviderAccountRequest(); // \OpenAPI\Client\Model\ProviderAccountRequest

try {
    $result = $apiInstance->circuitsProviderAccountsCreate($provider_account_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProviderAccountsDestroy($id)
```
...
$id = 56; // int | A unique integer value identifying this provider account.

try {
    $apiInstance->circuitsProviderAccountsDestroy($id);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this provider account. | |
...
$account = array('account_example'); // string[]
$account__empty = True; // bool
$account__ic = array('account__ic_example'); // string[]
$account__ie = array('account__ie_example'); // string[]
$account__iew = array('account__iew_example'); // string[]
$account__isw = array('account__isw_example'); // string[]
$account__n = array('account__n_example'); // string[]
$account__nic = array('account__nic_example'); // string[]
$account__nie = array('account__nie_example'); // string[]
$account__niew = array('account__niew_example'); // string[]
$account__nisw = array('account__nisw_example'); // string[]
$created = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$created__empty = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$created__gt = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
$created__gte = array(new \DateTime("2013-10-20T19:20:30+01:00")); // \DateTime[]
...
try {
    $result = $apiInstance->circuitsProviderAccountsList($account, $account__empty, $account__ic, $account__ie, $account__iew, $account__isw, $account__n, $account__nic, $account__nie, $account__niew, $account__nisw, $created, $created__empty, $created__gt, $created__gte, $created__lt, $created__lte, $created__n, $created_by_request, $description, $description__empty, $description__ic, $description__ie, $description__iew, $description__isw, $description__n, $description__nic, $description__nie, $description__niew, $description__nisw, $id, $id__empty, $id__gt, $id__gte, $id__lt, $id__lte, $id__n, $last_updated, $last_updated__empty, $last_updated__gt, $last_updated__gte, $last_updated__lt, $last_updated__lte, $last_updated__n, $limit, $modified_by_request, $name, $name__empty, $name__ic, $name__ie, $name__iew, $name__isw, $name__n, $name__nic, $name__nie, $name__niew, $name__nisw, $offset, $ordering, $provider, $provider__n, $provider_id, $provider_id__n, $q, $tag, $tag__n, $updated_by_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsList: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **account** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__empty** | **bool**|  | [optional] |
| **account__ic** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__ie** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__iew** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__isw** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__n** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__nic** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__nie** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__niew** | [**string[]**](../Model/string.md)|  | [optional] |
| **account__nisw** | [**string[]**](../Model/string.md)|  | [optional] |
| **created** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **created__empty** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **created__gt** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
| **created__gte** | [**\DateTime[]**](../Model/\DateTime.md)|  | [optional] |
...
[**\OpenAPI\Client\Model\PaginatedProviderAccountList**](../Model/PaginatedProviderAccountList.md)
...
```php
circuitsProviderAccountsPartialUpdate($id, $patched_provider_account_request): \OpenAPI\Client\Model\ProviderAccount
```
...
$id = 56; // int | A unique integer value identifying this provider account.
$patched_provider_account_request = new \OpenAPI\Client\Model\PatchedProviderAccountRequest(); // \OpenAPI\Client\Model\PatchedProviderAccountRequest

try {
    $result = $apiInstance->circuitsProviderAccountsPartialUpdate($id, $patched_provider_account_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this provider account. | |
| **patched_provider_account_request** | [**\OpenAPI\Client\Model\PatchedProviderAccountRequest**](../Model/PatchedProviderAccountRequest.md)|  | [optional] |
...
```php
circuitsProviderAccountsRetrieve($id): \OpenAPI\Client\Model\ProviderAccount
```
...
try {
    $result = $apiInstance->circuitsProviderAccountsRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProviderAccountsUpdate($id, $provider_account_request): \OpenAPI\Client\Model\ProviderAccount
```
...
try {
    $result = $apiInstance->circuitsProviderAccountsUpdate($id, $provider_account_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderAccountsUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProviderNetworksBulkDestroy($provider_network_request)
```
...
$provider_network_request = array(new \OpenAPI\Client\Model\ProviderNetworkRequest()); // \OpenAPI\Client\Model\ProviderNetworkRequest[]

try {
    $apiInstance->circuitsProviderNetworksBulkDestroy($provider_network_request);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksBulkDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **provider_network_request** | [**\OpenAPI\Client\Model\ProviderNetworkRequest[]**](../Model/ProviderNetworkRequest.md)|  | |
...
```php
circuitsProviderNetworksBulkPartialUpdate($provider_network_request): \OpenAPI\Client\Model\ProviderNetwork[]
```
...
try {
    $result = $apiInstance->circuitsProviderNetworksBulkPartialUpdate($provider_network_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksBulkPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\ProviderNetwork[]**](../Model/ProviderNetwork.md)
...
```php
circuitsProviderNetworksBulkUpdate($provider_network_request): \OpenAPI\Client\Model\ProviderNetwork[]
```
...
try {
    $result = $apiInstance->circuitsProviderNetworksBulkUpdate($provider_network_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksBulkUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProviderNetworksCreate($provider_network_request): \OpenAPI\Client\Model\ProviderNetwork
```
...
$provider_network_request = new \OpenAPI\Client\Model\ProviderNetworkRequest(); // \OpenAPI\Client\Model\ProviderNetworkRequest

try {
    $result = $apiInstance->circuitsProviderNetworksCreate($provider_network_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProviderNetworksDestroy($id)
```
...
try {
    $apiInstance->circuitsProviderNetworksDestroy($id);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
$provider_id__n = array(56); // int[] | Provider (ID)
$q = 'q_example'; // string | Search
$service_id = array('service_id_example'); // string[]
$service_id__empty = True; // bool
$service_id__ic = array('service_id__ic_example'); // string[]
$service_id__ie = array('service_id__ie_example'); // string[]
$service_id__iew = array('service_id__iew_example'); // string[]
$service_id__isw = array('service_id__isw_example'); // string[]
$service_id__n = array('service_id__n_example'); // string[]
$service_id__nic = array('service_id__nic_example'); // string[]
$service_id__nie = array('service_id__nie_example'); // string[]
$service_id__niew = array('service_id__niew_example'); // string[]
$service_id__nisw = array('service_id__nisw_example'); // string[]
$tag = array('tag_example'); // string[]
$tag__n = array('tag__n_example'); // string[]
$updated_by_request = 'updated_by_request_example'; // string

try {
    $result = $apiInstance->circuitsProviderNetworksList($created, $created__empty, $created__gt, $created__gte, $created__lt, $created__lte, $created__n, $created_by_request, $description, $description__empty, $description__ic, $description__ie, $description__iew, $description__isw, $description__n, $description__nic, $description__nie, $description__niew, $description__nisw, $id, $id__empty, $id__gt, $id__gte, $id__lt, $id__lte, $id__n, $last_updated, $last_updated__empty, $last_updated__gt, $last_updated__gte, $last_updated__lt, $last_updated__lte, $last_updated__n, $limit, $modified_by_request, $name, $name__empty, $name__ic, $name__ie, $name__iew, $name__isw, $name__n, $name__nic, $name__nie, $name__niew, $name__nisw, $offset, $ordering, $provider, $provider__n, $provider_id, $provider_id__n, $q, $service_id, $service_id__empty, $service_id__ic, $service_id__ie, $service_id__iew, $service_id__isw, $service_id__n, $service_id__nic, $service_id__nie, $service_id__niew, $service_id__nisw, $tag, $tag__n, $updated_by_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksList: ', $e->getMessage(), PHP_EOL;
}
```
...
| **service_id__empty** | **bool**|  | [optional] |
| **service_id__ic** | [**string[]**](../Model/string.md)|  | [optional] |
| **service_id__ie** | [**string[]**](../Model/string.md)|  | [optional] |
| **service_id__iew** | [**string[]**](../Model/string.md)|  | [optional] |
| **service_id__isw** | [**string[]**](../Model/string.md)|  | [optional] |
| **service_id__n** | [**string[]**](../Model/string.md)|  | [optional] |
| **service_id__nic** | [**string[]**](../Model/string.md)|  | [optional] |
| **service_id__nie** | [**string[]**](../Model/string.md)|  | [optional] |
| **service_id__niew** | [**string[]**](../Model/string.md)|  | [optional] |
| **service_id__nisw** | [**string[]**](../Model/string.md)|  | [optional] |
| **tag** | [**string[]**](../Model/string.md)|  | [optional] |
| **tag__n** | [**string[]**](../Model/string.md)|  | [optional] |
| **updated_by_request** | **string**|  | [optional] |
...
[**\OpenAPI\Client\Model\PaginatedProviderNetworkList**](../Model/PaginatedProviderNetworkList.md)
...
```php
circuitsProviderNetworksPartialUpdate($id, $patched_provider_network_request): \OpenAPI\Client\Model\ProviderNetwork
```
...
$id = 56; // int | A unique integer value identifying this provider network.
$patched_provider_network_request = new \OpenAPI\Client\Model\PatchedProviderNetworkRequest(); // \OpenAPI\Client\Model\PatchedProviderNetworkRequest

try {
    $result = $apiInstance->circuitsProviderNetworksPartialUpdate($id, $patched_provider_network_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this provider network. | |
| **patched_provider_network_request** | [**\OpenAPI\Client\Model\PatchedProviderNetworkRequest**](../Model/PatchedProviderNetworkRequest.md)|  | [optional] |
...
```php
circuitsProviderNetworksRetrieve($id): \OpenAPI\Client\Model\ProviderNetwork
```
...
try {
    $result = $apiInstance->circuitsProviderNetworksRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProviderNetworksUpdate($id, $provider_network_request): \OpenAPI\Client\Model\ProviderNetwork
```
...
try {
    $result = $apiInstance->circuitsProviderNetworksUpdate($id, $provider_network_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProviderNetworksUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProvidersBulkDestroy($provider_request)
```
...
$provider_request = array(new \OpenAPI\Client\Model\ProviderRequest()); // \OpenAPI\Client\Model\ProviderRequest[]

try {
    $apiInstance->circuitsProvidersBulkDestroy($provider_request);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersBulkDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **provider_request** | [**\OpenAPI\Client\Model\ProviderRequest[]**](../Model/ProviderRequest.md)|  | |
...
```php
circuitsProvidersBulkPartialUpdate($provider_request): \OpenAPI\Client\Model\Provider[]
```
...
try {
    $result = $apiInstance->circuitsProvidersBulkPartialUpdate($provider_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersBulkPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\OpenAPI\Client\Model\Provider[]**](../Model/Provider.md)
...
```php
circuitsProvidersBulkUpdate($provider_request): \OpenAPI\Client\Model\Provider[]
```
...
try {
    $result = $apiInstance->circuitsProvidersBulkUpdate($provider_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersBulkUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProvidersCreate($provider_request): \OpenAPI\Client\Model\Provider
```
...
$provider_request = new \OpenAPI\Client\Model\ProviderRequest(); // \OpenAPI\Client\Model\ProviderRequest

try {
    $result = $apiInstance->circuitsProvidersCreate($provider_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersCreate: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    $apiInstance->circuitsProvidersDestroy($id);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersDestroy: ', $e->getMessage(), PHP_EOL;
}
```
...
$asn = array(56); // int[] | ASN
$asn__n = array(56); // int[] | ASN
$asn_id = array(56); // int[] | ASN (ID)
$asn_id__n = array(56); // int[] | ASN (ID)
$contact = array(56); // int[] | Contact
$contact__n = array(56); // int[] | Contact
$contact_group = array('contact_group_example'); // string[]
$contact_group__n = array('contact_group__n_example'); // string[]
...
try {
    $result = $apiInstance->circuitsProvidersList($asn, $asn__n, $asn_id, $asn_id__n, $contact, $contact__n, $contact_group, $contact_group__n, $contact_role, $contact_role__n, $created, $created__empty, $created__gt, $created__gte, $created__lt, $created__lte, $created__n, $created_by_request, $description, $description__empty, $description__ic, $description__ie, $description__iew, $description__isw, $description__n, $description__nic, $description__nie, $description__niew, $description__nisw, $id, $id__empty, $id__gt, $id__gte, $id__lt, $id__lte, $id__n, $last_updated, $last_updated__empty, $last_updated__gt, $last_updated__gte, $last_updated__lt, $last_updated__lte, $last_updated__n, $limit, $modified_by_request, $name, $name__empty, $name__ic, $name__ie, $name__iew, $name__isw, $name__n, $name__nic, $name__nie, $name__niew, $name__nisw, $offset, $ordering, $q, $region, $region__n, $region_id, $region_id__n, $site, $site__n, $site_group, $site_group__n, $site_group_id, $site_group_id__n, $site_id, $site_id__n, $slug, $slug__empty, $slug__ic, $slug__ie, $slug__iew, $slug__isw, $slug__n, $slug__nic, $slug__nie, $slug__niew, $slug__nisw, $tag, $tag__n, $updated_by_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersList: ', $e->getMessage(), PHP_EOL;
}
```
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **asn** | [**int[]**](../Model/int.md)| ASN | [optional] |
| **asn__n** | [**int[]**](../Model/int.md)| ASN | [optional] |
| **asn_id** | [**int[]**](../Model/int.md)| ASN (ID) | [optional] |
| **asn_id__n** | [**int[]**](../Model/int.md)| ASN (ID) | [optional] |
| **contact** | [**int[]**](../Model/int.md)| Contact | [optional] |
| **contact__n** | [**int[]**](../Model/int.md)| Contact | [optional] |
| **contact_group** | [**string[]**](../Model/string.md)|  | [optional] |
| **contact_group__n** | [**string[]**](../Model/string.md)|  | [optional] |
...
[**\OpenAPI\Client\Model\PaginatedProviderList**](../Model/PaginatedProviderList.md)
...
```php
circuitsProvidersPartialUpdate($id, $patched_provider_request): \OpenAPI\Client\Model\Provider
```
...
$id = 56; // int | A unique integer value identifying this provider.
$patched_provider_request = new \OpenAPI\Client\Model\PatchedProviderRequest(); // \OpenAPI\Client\Model\PatchedProviderRequest

try {
    $result = $apiInstance->circuitsProvidersPartialUpdate($id, $patched_provider_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersPartialUpdate: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **id** | **int**| A unique integer value identifying this provider. | |
| **patched_provider_request** | [**\OpenAPI\Client\Model\PatchedProviderRequest**](../Model/PatchedProviderRequest.md)|  | [optional] |
...
```php
circuitsProvidersRetrieve($id): \OpenAPI\Client\Model\Provider
```
...
try {
    $result = $apiInstance->circuitsProvidersRetrieve($id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
circuitsProvidersUpdate($id, $provider_request): \OpenAPI\Client\Model\Provider
```
...
try {
    $result = $apiInstance->circuitsProvidersUpdate($id, $provider_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling CircuitsApi->circuitsProvidersUpdate: ', $e->getMessage(), PHP_EOL;
}
```
